...
function SmartWizard(target, options) {
    ...
    var _init = function($this) {
        ...
        if(NIK.length==0){
		  $("#myModal4").modal('show');
            $("#pesan4").text('NIK Harus Di isi'); 
			return false();
		}
        if(NamaKaryawan.length==0){
		  $("#myModal4").modal('show');
            $("#pesan4").text('Nama Karyawan Harus Di isi'); 
			return false();
		}  
        if(Tlpn1.length==0){
		  $("#myModal4").modal('show');
            $("#pesan4").text('Mobile Harus Di isi'); 
			return false();
		} 
        if(Kota.length==0){
		  $("#myModal4").modal('show');
            $("#pesan4").text('Kota Asal Harus Di isi'); 
			return false();
		} 
        if(TglMasuk.length==0){
		  $("#myModal4").modal('show');
            $("#pesan4").text('Tanggal Masuk Harus Di isi'); 
			return false();
		}
