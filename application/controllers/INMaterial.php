<?php
class INMaterial extends CI_Controller{
 function __construct(){
 parent::__construct();
 $this->load->model(array('INMaterial_model','app_model'));
...
function index(){
 ...
 $MasterList=$this->INMaterial_model->MasterList();
...
$this->template->display('INMaterial/index',$d); }
    
function MasterList(){
 $DB=$this->INMaterial_model->MasterList();
 $data['MListProduct']=$DB->result();
 $this->load->view('INMaterial/master_list',$data); }    

function MasterListPartner(){
 $DB=$this->INMaterial_model->MasterListPartner();
 $data['list']=$DB->result();
 $this->load->view('INMaterial/master_partner',$data); }
    
function TransactionList(){
 $DB=$this->INMaterial_model->transaction_list();
 $data['list']=$DB->result();
 $this->load->view('INMaterial/TransactionList',$data); }
    
function DataDetailMatIn(){
 $id = $this->input->post('kode');
 $DB =$this->INMaterial_model->transaction_detail($id);
 $data['list']=$DB->result();
 $this->load->view('INMaterial/DetailMatIn',$data); }
    
function DataDetailMatIn2(){
 $id = $this->input->post('kode');
 $DB =$this->INMaterial_model->transaction_detail($id);
 $data['list']=$DB->result();
 $this->load->view('INMaterial/DetailMatIn2',$data); }
...
public function PrintList(){
 ...
 $d['data']=$DB->result();
 $d['num'] = $DB->num_rows();					
 $this->load->view('INMaterial/PrintList',$d);     }
...
public function PrintList2(){
 ...
 $d['PartnerID'] = "Semua Supplier"; }
 $d['ItemID'] = $this->uri->segment(7);           
 $DB = $this->INMaterial_model->transaction_detail_report($tgl1,$tgl2,$IDCust,$DocNum,$PartnerID);
 $d['data']=$DB->result(); 
 $d['num'] = $DB->num_rows();                
 $this->load->view('INMaterial/PrintList2',$d); }
...
public function ReadReport(){
 ...
 $DB = $this->INMaterial_model->transaction_detail_report($tgl1,$tgl2,$IDCust,$DocNum,$PartnerID);
 $d['list']=$DB->result();              
 $this->load->view('INMaterial/transaction_detail_report',$d); }
...
public function ExportReport(){
 ...
 $d['data']= $DB->result(); 
 $d['num'] = $DB->num_rows();                
 $this->load->view('INMaterial/ExportListReport',$d); }
...
public function DetailPrint(){
 ...
 $DB =$this->INMaterial_model->transaction_detail($id);
 $d['data']=$DB->result();					
 $this->load->view('INMaterial/PrintMaterialIn',$d);   }
...
public function DetailPrint2(){
 ...
 $DB =$this->INMaterial_model->transaction_detail_2($id);
 $d['data']=$DB->result();					
 $this->load->view('INMaterial/PrintMaterialIn',$d);   }
...
public function SimpanMaterialIn(){
 ...
 $Detail['BalMat']               = $this->input->post('BalMat') ;
 $Detail['BalPcs']               = $this->input->post('BalPcs') ;
 ...
 $Detail['MatNum']             = $this->input->post('MatNum') ; 
 $Detail2['PcsPerSheet']          = $this->input->post('PcsPerSheet') ;
 $Detail2['PcsPerKg']             = $this->input->post('PcsPerKg') ;              
 ...
 $IndexDetail['SJNum']                = $this->input->post('SJNum') ;
 $IndexDetail['SJDate']               = $this->app_model->tgl_sql($this->input->post('SJDate')) ;
