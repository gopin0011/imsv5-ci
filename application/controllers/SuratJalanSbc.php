<?php
class SuratJalanSbc extends CI_Controller{
 ...
 function index()
 {
    ...
    //echo"</pre>";
    $d['Partner'] = $this->app_model->dbQuery("SELECT * FROM T010_Partner WHERE IsVendor = '1' ORDER BY PartnerCode")->result();
    $d['PartnerID'] = '';
    ...
    $this->template->display('SuratJalanSbc/index',$d);
 }
 ...
 function TransactionList()
 {
    ...
    $this->load->view('SuratJalanSbc/TransactionList',$data);
 }
 
 function DetailData()
 {
    $this->load->view('SuratJalanSbc/DetailData');
 } 
 ...
 function InfoTambahFormInFG()
 {
    ...
    if(empty($id)){
        $DocNumDetail = '001'   ; 
        $DocNum = $this->app_model->DocNumMaterialCreateSJSbcOther();
    }else{
    ...
    $d['Partner'] = $this->app_model->dbQuery("SELECT * FROM T010_Partner WHERE IsVendor = '1' AND ISNULL(PartnerCode,'') <> '' ORDER BY PartnerCode")->result();
    $d['PartnerID'] = '';
    $data['Templates'] = $this->load->view('SuratJalanSbc/tab_content2',$d,true);
 ...
 function MasterList()
 {
    $DB=$this->app_model->dbQuery("SELECT * FROM Q01_MProduct WHERE IsActive=1 AND IsSubcon=1 ORDER BY IDCust DESC");
    $data['MListProduct']=$DB->result();
    $this->load->view('SuratJalanSbc/master_list',$data); 
 }
 
 function MasterList2()
 {
    //$DB=$this->Ict_in_TR_model->MasterList();
    $DB = $this->app_model->dbQuery("SELECT * FROM Q01_MProduct WHERE IsSubcon=1 AND IsActive=1 AND IsDelete='X' ORDER BY IDCust DESC");
    $data['MListProduct']=$DB->result();
 ...
 function PrintList()
 {
    ...
    $sql = "SELECT a.*,b.ItemID,b.OrderReference,b.Quantity,b.IDUnit,c.*,d.*,ISNULL(b.JobNumber,c.PartNo) AS JobNumber
            ...
            WHERE a.RegID='$RegID' AND TypeID = '2' AND b.IsDelete = '0'";
    $DB = $this->app_model->dbQuery($sql);
    ...
    $sql2 = "SELECT a.*,b.*,c.username, NULL as Shipper, e.Dept_Name
            ...
            WHERE a.RegID='$RegID' AND TypeID = '2'";
    ...
    $this->load->view('SuratJalanSbc/PrintListNew',$d);
 }
 ...
 function DataDetailMatIn2()
 {
    ...
    $this->load->view('SuratJalanSbc/DetailMatIn2',$data);
 }
 ...
 function GetData()
 {
    ...
    $this->load->view('SuratJalanSbc/HeaderDetail',$data);
 }
 ...
 function GetData2()
 {
    ...
    $d['PartnerID'] = '';
    $FinalOutput = "";
    $FinalOutput .= $this->load->view('SuratJalanSbc/tab_content2',$d, true);
    ...
    function ReadReport()
    {
        ...
        $where = "AND b.DocDate BETWEEN '$tgl1' AND '$tgl2' AND b.TypeID='2'" ; 
        if(empty($ItemID2))
        {
        ...
        $d['tgl1'] = $tgl1;
        $d['tgl2'] = $tgl2;        
        $this->load->view('SuratJalanSbc/transaction_detail_report',$d);
    }
    ...
    function GetDetailFakturSJ()
    {
        ...
        $sql = "SELECT a.*, b.PartnerCode, c.UserName, (SELECT SUM(Quantity) FROM TD_SuratJalan WHERE IsDelete = '0' AND ItemID = '$ItemID' AND TH_RegID = a.RegID) AS Quantity
                ...
                AND TypeID = '2' AND a.DocDate BETWEEN '$tgl1' AND '$tgl2'
     ...
     function PrintListReport()
     {
        ...
        $this->load->view('SuratJalanSbc/PrintListReport',$d);
     }
