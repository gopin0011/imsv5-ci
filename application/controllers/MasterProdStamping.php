...
$this->load->library(array('form_validation','template'));
 $cek = $this->Role_Model->MProdStamping();
...
public function ConectingBomList(){
 ...
 $DB = $this->MasterProdStamping_model->ConectingBomList($id);
 $d['list']=$DB->result();
 $this->load->view('MasterProdStamping/ConectingBomList',$d); }
...
public function DeleteConecting(){
 ...
 if($data->num_rows()>0){
 $this->MasterProdStamping_model->DeleteConecting($SysID);
 }}
