<?php
class ReturnMaterial extends CI_Controller{
    
function __construct(){
 parent::__construct();
 $this->load->model(array('ReturnMaterial_model','app_model'));
...
function index(){
 ...
 $MasterList=$this->ReturnMaterial_model->MasterList();
...
$this->template->display('ReturnMaterial/index',$d); }
    
function MasterList(){
 $DB=$this->ReturnMaterial_model->MasterList();
 $data['MListProduct']=$DB->result();
 $this->load->view('ReturnMaterial/master_list',$data); }    
    
function List_Material(){
 $DB=$this->ReturnMaterial_model->List_Material();
 $data['list']=$DB->result();
 $this->load->view('ReturnMaterial/ListMaterial',$data); }
    
function TransactionList(){
 $DB=$this->ReturnMaterial_model->transaction_list();
 $data['list']=$DB->result();
 $this->load->view('ReturnMaterial/TransactionList',$data); }

function DataDetailMatIn(){
 $id = $this->input->post('kode');
 $DB =$this->ReturnMaterial_model->transaction_detail($id);
 $data['list']=$DB->result();
 $this->load->view('ReturnMaterial/DetailMatIn',$data); }
    
function DataDetailMatIn2(){
 $id = $this->input->post('kode');
 $DB =$this->ReturnMaterial_model->transaction_detail($id);
 $data['list']=$DB->result();
 $this->load->view('ReturnMaterial/DetailMatIn2',$data); }
...
public function DetailPrint(){
 ...
 $DB =$this->ReturnMaterial_model->transaction_detail($id);
 $d['data']=$DB->result();					
 $this->load->view('ReturnMaterial/PrintMaterialIn',$d);   }
             
public function DetailPrint2(){
 $d['judul'] = "Data Material Return";
 $id = $this->uri->segment(3);
 ...
 $DB =$this->ReturnMaterial_model->transaction_detail_2($id);
 $d['data']=$DB->result();					
 $this->load->view('ReturnMaterial/PrintMaterialIn',$d);   }
...
public function PrintList(){
 ...
 $d['judul']= "Transaksi Material Return" ; 
 ...
 $d['data']=$DB->result();
 $d['num'] = $DB->num_rows();					
 $this->load->view('ReturnMaterial/PrintList',$d);     }
...
public function PrintList2(){
 ...
 $DB = $this->ReturnMaterial_model->transaction_detail_report($tgl1,$tgl2,$IDCust,$PartNo);
 $d['data']=$DB->result(); 
 $d['num'] = $DB->num_rows();                
 $this->load->view('ReturnMaterial/PrintList2',$d); }
...
public function ReadReport(){
 ...
 $DB = $this->ReturnMaterial_model->transaction_detail_report($tgl1,$tgl2,$IDCust,$PartNo);
 $d['list']=$DB->result();              
 $this->load->view('ReturnMaterial/transaction_detail_report',$d); }
...
public function ExportReport(){
 ...
 $d['data']= $DB->result(); 
 $d['num'] = $DB->num_rows();                
 $this->load->view('ReturnMaterial/ExportListReport',$d); }
