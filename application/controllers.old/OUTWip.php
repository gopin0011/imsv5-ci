<?php
class OUTWip extends CI_Controller{
 function __construct(){
 parent::__construct();
 $this->load->model(array('OUTWip_model','app_model'));
 $this->load->library(array('form_validation','template'));
 $cek = $this->session->userdata('TrcWIP')=='1';
...
function index(){
 ...
 $MasterList=$this->OUTWip_model->MasterList();
...
$this->template->display('OUTWip/index',$d); }
    
function MasterList(){
 $DB=$this->OUTWip_model->MasterList();
 $data['MListProduct']=$DB->result();
 $this->load->view('OUTWip/master_list',$data); }    

function MasterListPartner(){
 $DB=$this->OUTWip_model->MasterListPartner();
 $data['list']=$DB->result();
 $this->load->view('OUTWip/master_partner',$data); }
    
function TransactionList(){
 $DB=$this->OUTWip_model->transaction_list();
 $data['list']=$DB->result();
 $this->load->view('OUTWip/TransactionList',$data); }
    
function DataDetailMatIn(){
 $id = $this->input->post('kode');
 $DB =$this->OUTWip_model->transaction_detail($id);
 $data['list']=$DB->result();
 $this->load->view('OUTWip/DetailMatIn',$data); }
    
function DataDetailMatIn2(){
 $id = $this->input->post('kode');
 $DB =$this->OUTWip_model->transaction_detail($id);
 $data['list']=$DB->result();
 $this->load->view('OUTWip/DetailMatIn2',$data); }
 
function DataDetailMatIn3(){
 $id = $this->input->post('kode');
 $DB =$this->OUTWip_model->transaction_detail($id);
 $data['list']=$DB->result();
 $this->load->view('OUTWip/DetailMatIn3',$data); }
...
public function ExportList(){
 ...
 $d['data']=$DB->result();
 $d['num'] = $DB->num_rows();					
 $this->load->view('OUTWip/ExportList',$d);     }
...
public function PrintList(){
 ...
 $d['data']=$DB->result();
 $d['num'] = $DB->num_rows();					
 $this->load->view('OUTWip/PrintList',$d);     }
...
public function PrintList2(){
 ...
 $DB = $this->OUTWip_model->transaction_detail_report($tgl1,$tgl2,$IDCust,$PartNo2);
 $d['data']=$DB->result(); 
 $d['num'] = $DB->num_rows();                
 $this->load->view('OUTWip/PrintList2',$d); }
...
public function ReadReport(){
 ...
 $DB = $this->OUTWip_model->transaction_detail_report($tgl1,$tgl2,$IDCust,$PartNo2);
 $d['list']=$DB->result();              
 $this->load->view('OUTWip/transaction_detail_report',$d); }
...
public function ExportReport(){
 ...
 $d['data']= $DB->result(); 
 $d['num'] = $DB->num_rows();                
 $this->load->view('OUTWip/ExportListReport',$d); }
...
public function DetailPrint(){
 ...
 $DB =$this->OUTWip_model->transaction_detail($id);
 $d['data']=$DB->result();					
 $this->load->view('OUTWip/PrintMaterialIn',$d);   }
...
public function DetailPrint2(){
 ...
 $DB =$this->OUTWip_model->transaction_detail_2($id);
 $d['data']=$DB->result();					
 $this->load->view('OUTWip/PrintMaterialIn',$d);   }
