<?php
class Material_out_TR extends CI_Controller{
function __construct(){
 parent::__construct();
 $this->load->model(array('Material_out_TR_model','app_model'));
 $this->load->library(array('form_validation','template'));
 $cek = $this->session->userdata('TrcStoreRoom')=='1';
...
function index(){
 ...
 $MasterList=$this->Material_out_TR_model->MasterList();
 ...
 $MListPartner = $this->Material_out_TR_model->MListPartner();
...
$this->template->display('Material_out_TR/index',$d);  }
    
function MasterList(){
 $DB=$this->Material_out_TR_model->MasterList();
 $data['MListProduct']=$DB->result();
 $this->load->view('Material_out_TR/master_list',$data); } 
 
function MasterList2(){
 $DB=$this->Material_out_TR_model->MasterList2();
 $data['MListProduct']=$DB->result();
 $this->load->view('Material_out_TR/master_list2',$data); }  
 
function MasterListPic(){
 $DB=$this->Material_out_TR_model->MasterListPic();
 $data['MListProduct']=$DB->result();
 $this->load->view('Material_out_TR/master_list_pic',$data); }   
...
function transaction_list(){
 $cek=$this->Material_out_TR_model->transaction_list();
 $data['list']=$cek->result();
 $this->load->view('Material_out_TR/transaction_list',$data); }
    
public function DetailPrint(){
 $d['judul'] = "Data Material Masuk";
 $id = $this->uri->segment(3);
 $cek =$this->Material_out_TR_model->transaction_detail($id);
 $d['data']=$cek->result();					
 $this->load->view('Material_out_TR/PrintMaterialIn',$d);  }
...
public function PrintList(){
 ...
 $d['data']=$cek->result();
 $d['num'] = $cek->num_rows();					
 $this->load->view('Material_out_TR/ExportList',$d); }
...
public function PrintList2(){
 ...
 $d['IDCust'] = $this->app_model->CariCustName($this->uri->segment(5));}else{
          ...
          $d['ItemID'] = $this->app_model->CariProductName($this->uri->segment(7));           
            ...
            $cek = $this->Material_out_TR_model->transaction_detail_report($DocDateReport_1,$DocDateReport_2,$IDCust,$DocNum,$PartnerID);
            $Stock = $this->Material_out_TR_model->Stock_List();
            $d['data']=$cek->result(); 
            $d['num'] = $cek->num_rows(); 
			$this->load->view('Material_out_TR/PrintList2',$d);
	}
...
function transaction_detail(){
 ...
 $cek =$this->Material_out_TR_model->transaction_detail($id);
 $data['list']=$cek->result();
 $this->load->view('Material_out_TR/transaction_detail',$data); }
    
function transaction_detail_2(){
 $id = $this->input->post('kode');
 $cek =$this->Material_out_TR_model->transaction_detail($id);
 $data['list']=$cek->result();
 $this->load->view('Material_out_TR/transaction_detail_2',$data); }
...
public function ReadReport(){
 ...
 $cek = $this->Material_out_TR_model->transaction_detail_report($tgl1,$tgl2,$IDCategory,$ItemID,$IDDepartment);
 $d['list']=$cek->result();              
 $this->load->view('Material_out_TR/transaction_detail_report',$d);
	}
...
public function ExportReport(){
 ...
 $d['data']=$cek->result(); 
 $d['num'] = $cek->num_rows(); 
 $this->load->view('Material_out_TR/ExportListReport',$d); }
...
public function DetailPrint2(){
 ...
 $d['DocNum'] =$id;
 $d['DocDate']	    =''; } 
 $cek =$this->Material_out_TR_model->transaction_detail2($id);
 $d['data']=$cek->result();					
 $this->load->view('Material_out_TR/PrintMaterialIn',$d);   }
