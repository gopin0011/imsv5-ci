<?php
class INFinishGood extends CI_Controller{
 function __construct(){
 parent::__construct();
 $this->load->model(array('INFinishGood_model','app_model'));
...
function index(){
 ...
 $MasterList=$this->INFinishGood_model->MasterList();
...
$text6 = "SELECT * FROM M_Shift2 WITH (NOLOCK)";
 $d['M_Shift'] = $this->app_model->manualQuery($text6);
$this->template->display('INFinishGood/index',$d); }
    
function MasterList(){
 $DB=$this->INFinishGood_model->MasterList();
 $data['MListProduct']=$DB->result();
 $this->load->view('INFinishGood/master_list',$data); }    

function MasterListPartner(){
 $DB=$this->INFinishGood_model->MasterListPartner();
 $data['list']=$DB->result();
 $this->load->view('INFinishGood/master_partner',$data); }
    
function TransactionList(){
 $DB=$this->INFinishGood_model->transaction_list();
 $data['list']=$DB->result();
 $this->load->view('INFinishGood/TransactionList',$data); }
    
function DataDetailMatIn(){
 $id = $this->input->post('kode');
 $DB =$this->INFinishGood_model->transaction_detail($id);
 $data['list']=$DB->result();
 $this->load->view('INFinishGood/DetailMatIn',$data); }
    
function DataDetailMatIn2(){
 $id = $this->input->post('kode');
 $DB =$this->INFinishGood_model->transaction_detail($id);
 $data['list']=$DB->result();
 $this->load->view('INFinishGood/DetailMatIn2',$data); }
 
function DataDetailMatIn3(){
 $id = $this->input->post('kode');
 $DB =$this->INFinishGood_model->transaction_detail($id);
 $data['list']=$DB->result();
 $this->load->view('INFinishGood/DetailMatIn3',$data); }
...
public function ExportList(){
 ...
 $d['data']=$DB->result();
 $d['num'] = $DB->num_rows();					
 $this->load->view('INFinishGood/ExportList',$d);     }
...
public function PrintList(){
 ...
 $d['data']=$DB->result();
 $d['num'] = $DB->num_rows();					
 $this->load->view('INFinishGood/PrintList',$d);     }
...
public function PrintList2(){
 ...
 $d['data']=$DB->result(); 
 $d['num'] = $DB->num_rows();                
 $this->load->view('INFinishGood/PrintList2',$d); }
...
public function ReadReport(){
 ...
 $DB = $this->INFinishGood_model->transaction_detail_report($tgl1,$tgl2,$IDCust,$PartNo2);
 $d['list']=$DB->result();              
 $this->load->view('INFinishGood/transaction_detail_report',$d); }
...
public function ExportReport(){
 ...
 $d['data']= $DB->result(); 
 $d['num'] = $DB->num_rows();                
 $this->load->view('INFinishGood/ExportListReport',$d); }
...
public function DetailPrint(){
 ...
 $DB =$this->INFinishGood_model->transaction_detail($id);
 $d['data']=$DB->result();					
 $this->load->view('INFinishGood/PrintMaterialIn',$d);   }
...
public function DetailPrint2(){
 ...
 $DB =$this->INFinishGood_model->transaction_detail_2($id);
 $d['data']=$DB->result();					
 $this->load->view('INFinishGood/PrintMaterialIn',$d);   }
