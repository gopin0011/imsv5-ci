<?php
class Material_in_TR extends CI_Controller{
function __construct(){
 parent::__construct();
 $this->load->model(array('Material_in_TR_model','app_model'));
...
function index(){
 ...
 $MasterList=$this->Material_in_TR_model->MasterList();
 ...
 $MListPartner = $this->Material_in_TR_model->MListPartner();
...
$this->template->display('Material_in_TR/index',$d);  }
    
function MasterList(){
 $DB=$this->Material_in_TR_model->MasterList();
 $data['MListProduct']=$DB->result();
 $this->load->view('Material_in_TR/master_list',$data); } 
 
function MasterListPartner(){
 $DB=$this->Material_in_TR_model->MListPartner();
 $data['MasterListPartner']=$DB->result();
 $this->load->view('Material_in_TR/master_partner',$data); }
 
function MasterList2(){
 $DB=$this->Material_in_TR_model->MasterList();
 $data['MListProduct']=$DB->result();
 $this->load->view('Material_in_TR/master_list2',$data); }    
...
function transaction_list(){
 $cek=$this->Material_in_TR_model->transaction_list();
 $data['list']=$cek->result();
 $this->load->view('Material_in_TR/transaction_list',$data); }
    
public function DetailPrint(){
 $d['judul'] = "Data Material Masuk";
 $id = $this->uri->segment(3);
 $cek =$this->Material_in_TR_model->transaction_detail($id);
 $d['data']=$cek->result();					
 $this->load->view('Material_in_TR/PrintMaterialIn',$d);  }
...
public function PrintList(){
 ...
 $d['data']=$cek->result();
 $d['num'] = $cek->num_rows();					
 $this->load->view('Material_in_TR/ExportList',$d); }
...
public function PrintList2(){
 ...
 $d['IDCust'] = $this->app_model->CariCustName($this->uri->segment(5));}else{
          ...
          $d['ItemID'] = $this->app_model->CariProductName($this->uri->segment(7));           
            ...
            $cek = $this->Material_in_TR_model->transaction_detail_report($DocDateReport_1,$DocDateReport_2,$IDCust,$DocNum,$PartnerID);
            $Stock = $this->Material_in_TR_model->Stock_List();
            $d['data']=$cek->result(); 
            $d['num'] = $cek->num_rows();                
			$this->load->view('Material_in_TR/PrintList2',$d);
	}
...
function transaction_detail(){
 ...
 $cek =$this->Material_in_TR_model->transaction_detail($id);
 $data['list']=$cek->result();
 $this->load->view('Material_in_TR/transaction_detail',$data); }
    
function transaction_detail_2(){
 $id = $this->input->post('kode');
 $cek =$this->Material_in_TR_model->transaction_detail($id);
 $data['list']=$cek->result();
 $this->load->view('Material_in_TR/transaction_detail_2',$data); }
...
public function ReadReport(){
 ...
 $cek = $this->Material_in_TR_model->transaction_detail_report($tgl1,$tgl2,$IDCategory,$ItemID,$PartnerID);
 $d['list']=$cek->result();              
 $this->load->view('Material_in_TR/transaction_detail_report',$d);
	}
...
public function ExportReport(){
 ...
 $d['data']=$cek->result(); 
 $d['num'] = $cek->num_rows();                
 $this->load->view('Material_in_TR/ExportListReport',$d); }
   ...
   public function DetailPrint2()
	{
            ...
            $cek =$this->Material_in_TR_model->transaction_detail2($id);
            $d['data']=$cek->result();					
			$this->load->view('Material_in_TR/PrintMaterialIn',$d);          
 	}
