...
function __construct(){
 parent::__construct();
 $this->load->model(array('Material_out_model','app_model'));
 ...
 elseif(empty($cek)){ redirect('welcome'); }}
    ...
    $d['title']="Home";
        ...
        $MasterList=$this->Material_out_model->MasterList();
...
$this->template->display('Material_out/index',$d);

    }
    
    function MasterList(){
        $DB=$this->Material_out_model->MasterList();
        $data['MListProduct']=$DB->result();
        $this->load->view('Material_out/master_list',$data); }    
...
date_default_timezone_set('Asia/Jakarta');		    
    ...
    function List_Material(){
        $cek=$this->Material_out_model->List_Material();
        $data['list']=$cek->result();
        $this->load->view('Material_out/List_Material',$data);
    }
    
    function transaction_list(){
        $cek=$this->Material_out_model->transaction_list();
        $data['list']=$cek->result();
        $this->load->view('Material_out/transaction_list',$data);
    }
    
    function transaction_detail(){
        $id = $this->input->post('id');
        $cek =$this->Material_out_model->transaction_detail($id);
        $data['list']=$cek->result();
        $this->load->view('Material_out/transaction_detail',$data);
    ...
    public function DetailPrint(){
            ...
            $cek =$this->Material_out_model->transaction_detail($id);
            $d['data']=$cek->result();					
			$this->load->view('Material_out/PrintMaterialIn',$d);          
    ...
    public function PrintList(){
            ...
            $d['data']=$cek->result();
            $d['num'] = $cek->num_rows();					
			$this->load->view('Material_out/PrintList',$d);          
    ...
    public function PrintList2(){
          ...
          $d['ItemID'] = $this->app_model->CariProductName($this->uri->segment(7));           
            ...
            $cek = $this->Material_out_model->transaction_detail_report($DocDateReport_1,$DocDateReport_2,$IDCust,$DocNum,$PartnerID);
            $Stock = $this->Material_out_model->Stock_List();
            $d['data']=$cek->result(); 
            $d['num'] = $cek->num_rows();                
			$this->load->view('Material_out/PrintList2',$d);
	}
    ...
    function transaction_detail_2(){
        ...
        $cek =$this->Material_out_model->transaction_detail($id);
        $data['list']=$cek->result();
        $this->load->view('Material_out/transaction_detail_2',$data);
    ...
    public function ReadReport(){
            ...
            $cek = $this->Material_out_model->transaction_detail_report($DocDateReport_1,$DocDateReport_2,$IDCust,$DocNum);
            $Stock = $this->Material_out_model->Stock_List();
            $d['list']=$cek->result();              
			$this->load->view('Material_out/transaction_detail_report',$d);
	}
...
public function ExportReport(){
    ...
    $d['data']=$cek->result(); 
    $d['num'] = $cek->num_rows();                
	$this->load->view('Material_out/ExportListReport',$d); }
   ...
   public function DetailPrint2()
	{
            ...
            $cek =$this->Material_out_model->transaction_detail2($id);
            $d['data']=$cek->result();					
			$this->load->view('Material_out/PrintMaterialIn',$d);          
 	}
