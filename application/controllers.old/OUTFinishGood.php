<?php
class OUTFinishGood extends CI_Controller{
 function __construct(){
 parent::__construct();
 $this->load->model(array('OUTFinishGood_model','app_model'));
 $this->load->library(array('form_validation','template'));
 $cek = $this->session->userdata('TrcWH')=='1';
...
function index(){
 ...
 $MasterList=$this->OUTFinishGood_model->MasterList();
...
$this->template->display('OUTFinishGood/index',$d); }
    
function MasterList(){
 $DB=$this->OUTFinishGood_model->MasterList();
 $data['MListProduct']=$DB->result();
 $this->load->view('OUTFinishGood/master_list',$data); }    

function MasterListPartner(){
 $DB=$this->OUTFinishGood_model->MasterListPartner();
 $data['list']=$DB->result();
 $this->load->view('OUTFinishGood/master_partner',$data); }
    
function TransactionList(){
 $DB=$this->OUTFinishGood_model->transaction_list();
 $data['list']=$DB->result();
 $this->load->view('OUTFinishGood/TransactionList',$data); }
    
function DataDetailMatIn(){
 $id = $this->input->post('kode');
 $DB =$this->OUTFinishGood_model->transaction_detail($id);
 $data['list']=$DB->result();
 $this->load->view('OUTFinishGood/DetailMatIn',$data); }
    
function DataDetailMatIn2(){
 $id = $this->input->post('kode');
 $DB =$this->OUTFinishGood_model->transaction_detail($id);
 $data['list']=$DB->result();
 $this->load->view('OUTFinishGood/DetailMatIn2',$data); }
 
function DataDetailMatIn3(){
 $id = $this->input->post('kode');
 $DB =$this->OUTFinishGood_model->transaction_detail($id);
 $data['list']=$DB->result();
 $this->load->view('OUTFinishGood/DetailMatIn3',$data); }
...
public function ExportList(){
 ...
 $d['data']=$DB->result();
 $d['num'] = $DB->num_rows();					
 $this->load->view('OUTFinishGood/ExportList',$d);     }
...
public function PrintList(){
 ...
 $d['data']=$DB->result();
 $d['num'] = $DB->num_rows();					
 $this->load->view('OUTFinishGood/PrintList',$d);     }
...
public function PrintList2(){
 ...
 $DB = $this->OUTFinishGood_model->transaction_detail_report($tgl1,$tgl2,$IDCust,$PartNo2);
 $d['data']=$DB->result(); 
 $d['num'] = $DB->num_rows();                
 $this->load->view('OUTFinishGood/PrintList2',$d); }
...
public function ReadReport(){
 ...
 $DB = $this->OUTFinishGood_model->transaction_detail_report($tgl1,$tgl2,$IDCust,$PartNo2);
 $d['list']=$DB->result();              
 $this->load->view('OUTFinishGood/transaction_detail_report',$d); }
...
public function ExportReport(){
 ...
 $d['data']= $DB->result(); 
 $d['num'] = $DB->num_rows();                
 $this->load->view('OUTFinishGood/ExportListReport',$d); }
...
public function DetailPrint(){
 ...
 $DB =$this->OUTFinishGood_model->transaction_detail($id);
 $d['data']=$DB->result();					
 $this->load->view('OUTFinishGood/PrintMaterialIn',$d);   }
...
public function DetailPrint2(){
 ...
 $DB =$this->OUTFinishGood_model->transaction_detail_2($id);
 $d['data']=$DB->result();					
 $this->load->view('OUTFinishGood/PrintMaterialIn',$d);   }
