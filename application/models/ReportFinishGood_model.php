...
function ReadStockCard_27042017($tgl1,$tgl2,$ItemID){  
$where = "WHERE ItemID='$ItemID' AND DocDate BETWEEN '$tgl1' AND '$tgl2'";
$where2 = "WHERE b.ItemID='$ItemID' AND a.DocDate BETWEEN '$tgl1' AND '$tgl2'";      
$text = "(SELECT * FROM SCFG $where)";

$text .= " UNION 
           (
                SELECT TOP (100) PERCENT a.DocNum, a.DocNum+''+b.DocNumDetail AS DocNumDetail, a.DocDate,a.create_time as DocTime, b.ItemID, c.PartNo, c.PartName, b.QtyMat AS INMat, NULL AS OUTMat, c.IDCust, d.Code, d.CustName, c.Spec1, c.Spec2, c.PcsPerSheet, c.PcsPerKg 
