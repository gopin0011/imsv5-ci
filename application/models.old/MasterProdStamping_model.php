<?php class MasterProdStamping_model extends CI_Model{


function MasterList($id){ return $this->db->query("SELECT * FROM Q01_MProduct WHERE IsStamping=1 AND IDCust='$id' ORDER BY PartName ASC"); }
