...
$bulan = $this->MasterProdMaterial_model->getBulan(substr($tgl,5,2));
...
function MasterList($id){ return $this->db->query("SELECT * FROM Q01_MProduct WHERE IsMaterial=1 AND IDCust='$id' ORDER BY PartName ASC"); }
