...
$cust = $row->Code;
$input = $this->app_model->CariJmlinput_ks1($row->ItemID,$tgl_awal,$tgl_akhir);
$input2 = $this->app_model->RMStock($row->ItemID);
$input3 = $this->app_model->CariJmlinput_ks1($row->ItemID,$tgl_awal,$tgl_akhir2);
