<table id="t_list_master7" class="table table-bordered table-striped">
<thead>
<tr class="headings">
    <th>PartNo</th>  
    <th>PartName</th>  
...
?>    
<tr class="odd gradeX" style="cursor:pointer" onclick="javascript:pilih7('<?php echo $row->RegID;?>')">
...
<script> $(function () { $("#t_list_master7").DataTable(); });</script>