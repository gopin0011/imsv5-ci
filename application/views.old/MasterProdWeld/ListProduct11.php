<table id="t_list_master11" class="table table-bordered table-striped">
<thead>
<tr class="headings">
    <th>PartNo</th>  
    <th>PartName</th>  
...
?>    
<tr class="odd gradeX" style="cursor:pointer" onclick="javascript:pilih11('<?php echo $row->RegID;?>')">
...
<script> $(function () { $("#t_list_master11").DataTable(); });</script>