...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_report_GA/MasterList",
data	: "kode="+kode,
cache	: false,
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_report_GA/ReadReport",
data	: string,
cache	: false,
success	: function(data){
setTimeout(function(){
...
$("#Export").click(function(){
 ...
 setTimeout(function(){
 waitingDialog3.hide();
 window.open('<?php echo site_url();?>/Material_report_GA/ExportReport/'+string);
 },1000)       
 return false(); });    
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_report_GA/ReadStockCard",
data	: string,
cache	: false,
success	: function(data){
setTimeout(function(){
