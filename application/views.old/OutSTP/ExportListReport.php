...
$kanan = "<table class='kanan' width='100%'>
          ...
          <tr>
		  	<td colspan='2'>Gedung</td>
			<td width='5' colspan='4'>: ".$Factory."</td>
		  </tr>
          <tr>
...
<tr>
 ...
 <td align="left"><?php echo number_format($row->Qty ); ?></td>
...
header("Content-Disposition: attachment; filename=ProdPress_$filter2.xls");
