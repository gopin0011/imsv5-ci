...
.style101 {font-size: 10px; font-family: Arial, Helvetica, sans-serif; }
-->
</style>
</head>
...
<table width="330" height="340" border="1" cellspacing="0">
  ...
  <tr>
    <td height="34" colspan="2"><div align="center"><span class="style101"><?php echo $line; ?>-<?php echo $DetailLine; ?> </span></div></td>
    <td colspan="2"><div align="center"><span class="style101"> <?php echo $DocDate ; ?></span></div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><div align="left"><span class="style11">Lot No. :  <?php echo $db->LotNo ; ?></span></div></td>
    <td colspan="4"><div align="left"><span class="style11">Van No : <?php echo $db->VanNo ; ?></span></div></td>
  </tr>
  <tr>
    <td colspan="6"><div align="left"><span class="style11">Customer : <strong><?php echo $db->Customer  ; ?></strong> </span></div></td>
  </tr>
  <tr>
      <td height="25"><div align="left" class="style9">STD Pack : <span class="style1"><?php echo $db->StdPack  ; ?></span> </div></td>
  ...
  <tr>
    ...
    <td width="84" colspan="2"><div align="center"><span class="style2"> <h3><?php echo $db->Status ; ?></strong> </h3></div></td>
    <td colspan="2"><div align="center"><span class="style2"><?php echo $db->QCCheck  ; ?></span></div></td>
  </tr>
  <tr>
    <td colspan="4"><div align="left"><span class="style10">CM 1 : <?php echo $db->OP1 ; ?></span></div></td>
    
  </tr>
  <tr>
    <td colspan="4"><div align="left"><span class="style10">CM 2 : <?php echo $db->OP2 ; ?></span></div></td>
