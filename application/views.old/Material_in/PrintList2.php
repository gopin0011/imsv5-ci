...
foreach($data as $row){  
    ...
    <td class="tg-h31u1"><?php echo $row->Spec ; ?> <?php echo $row->Thick ; ?> X <?php echo $row->Width ; ?> X <?php echo $row->Length ; ?></td>
    <td class="tg-h31u1"><?php echo $row->Code; ?></td>
    <td class="tg-h31u1"><?php echo $row->partner_code; ?></td>
    <td class="tg-h31u1"><?php echo $MatNum ;?></td>
