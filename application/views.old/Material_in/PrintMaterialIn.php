...
<img src="<?php echo site_url();?>/Material_in/bikin_barcode/<?php echo $id ;?>" style="width: 280px;">
  ...
  <tr>
    ...
    <td colspan="7" class="style21"><?php echo $db->Spec; ?>&nbsp;<?php echo $db->Spec; ?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="7" class="style21"><?php echo $db->DocNum_Ext; ?>&nbsp;</td>
    <td colspan="4"><span class="style21"><?php echo $db->DocNumDetail; ?></span></td>
    <td colspan="5" class="style21"><?php echo $db->username; ?>&nbsp;</td>
  </tr>
  <tr><span>
