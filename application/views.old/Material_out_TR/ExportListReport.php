...
$kanan = "<table class='kanan' width='100%'>
		  <tr>
			...
			<td width='5'>: ".$this->session->userdata('nama_lengkap')."</td>
		  </tr>
          <tr>
          ...
          <tr>
			...
			<td width='5'>: ".$IDCategory."</td>
		  </tr>
          <tr>
		  	<td colspan='2'>Department</td>
			<td width='5'>: ".$IDDepartment."</td>
		  </tr>
          <tr>
...
foreach($data as $row){  
 ...
 <td align="left"><?php echo $Pic; ?></td>
 <td align="left"><?php echo $dept ; ?></td>
...
header("Content-Disposition: attachment; filename=TR_Product-Out.xls");
