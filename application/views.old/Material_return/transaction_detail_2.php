...
$DocDate2 = $this->Material_return_model->tgl_str($row->DocDate) ;
$CreateDate = $this->Material_return_model->tgl_str($row->CreateDate) ; 
...
<td align="center" width="40"><?php echo $Total ; ?></td>
...
<?php } ?> <?php } ?> 
            ...
            onclick="window.open(&#39;<?php echo base_url();?>index.php/Material_return/DetailPrint2/<?php echo $DocNumDetail ;?>&#39;,&#39;&#39;,&#39; scrollbars=yes,menubar=no,width=1100,height=600, resizable=yes,toolbar=no,location=no,status=no&#39;)">
