...
window.open('<?php echo site_url();?>/Sony_prod/print_list/'+kode , 'myWindow', 
...
function AmbilForm(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Sony_prod/RegDocNumSony_Head",
			data	: "kode="+kode,
			cache	: false,
			dataType : "json",
...
function AmbilFormDetail(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Sony_prod/RegDocNumSony_Detail",
			data	: "kode="+kode,
			cache	: false,
			dataType : "json",
			success	: function(data){
...
function AmbilFormAdd(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Sony_prod/RegDocNumSony_Add",
			data	: "id="+id,
			cache	: false,
			dataType : "json",
			success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Sony_prod/transaction_list",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Sony_prod/transaction_detail",
data	: "id="+id,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Sony_prod/transaction_detail_2",
data	: "id="+id,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Sony_prod/Save",
...
NotifFail('Server tidak merespon :'+kesalahan);	}		
   ...
   function NotifFail(data){
	...
	function CariProfilProduct(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Sony_prod/InfoMaterial_product",
			data	: "kode="+kode,
			cache	: false,
			dataType : "json",
			success	: function(data){
...
$("#HapusDetail").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Sony_prod/Hapus_Detail",
 ...
 $("#HapusDetail2").click(function(){
    ...
    $("#export_list").click(function(){
		...
		window.open('<?php echo site_url();?>/Sony_prod/export_list/'+string);
		return false();	
	});
...
$("#export_list3").click(function(){
       var ShiftIDReport = $("#ShiftIDReport").val();
		...
		window.open('<?php echo site_url();?>/Sony_prod/export_list_report/'+string);
		return false();	
	});
...
window.open('<?php echo site_url();?>/Sony_prod/print_list_report/'+string , 'myWindow', 
'status = 1, height = 650, width = 1100, resizable = 0, toolbar=no, location=no, status=no&#39, menubar=no, address bar=no' );
return false(); });    
    ...
    $("#Search").click(function(){
		...
		if(DocDateReport_1.length==0){
		 ...
		 $.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Sony_prod/ReadReport",
			data	: string,
			cache	: false,
			success	: function(data){
				setTimeout(function(){
