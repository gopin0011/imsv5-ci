...
<col style='width: 100px'>
 ...
 <?php echo $kanan ;?>
  ...
  <tr>
    ...
    <th class="tg-l77s" colspan="1">Barcode A</th>
    <th class="tg-l77s" colspan="2">Barcode B</th>
    <th class="tg-l77s" colspan="2">Product</th>
    <th class="tg-a2cf" colspan="2">Log</th>
...
$DocNum = md5($row->DocNum) ;
    ...
    <td class="tg-h31u" colspan="1"><?php echo $row->DocNum_Ext ; ?></td>
    <td class="tg-h31u" colspan="2"><?php echo $row->DocNum_Ext_D ; ?></td>
    <td class="tg-h31u" colspan="2"><?php echo $row->PartNo ; ?> - <?php echo $row->PartName ; ?></td>
    <td class="tg-h31u1" colspan="2"><?php echo $CreateDate ; ?> <?php echo $row->DocTime ; ?></td>
