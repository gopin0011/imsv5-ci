...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_report_TR/MasterList",
data	: "kode="+kode,
cache	: false,
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_report_TR/ReadReport",
data	: string,
cache	: false,
success	: function(data){
setTimeout(function(){
...
$("#Export").click(function(){
 ...
 setTimeout(function(){
 waitingDialog3.hide();
 window.open('<?php echo site_url();?>/Material_report_TR/ExportReport/'+string);
 },1000)       
 return false(); });    
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_report_TR/ReadStockCard",
data	: string,
cache	: false,
success	: function(data){
setTimeout(function(){
