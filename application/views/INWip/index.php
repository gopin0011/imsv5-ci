...
$('#reload').on('click', function() {
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/INWip/TransactionList",
 data	: "kode="+kode,
 cache	: false,
...
function AmbilFormEdit(){
 ...
 $("#StockWIP2").val(data.StockWIP2);
 $("#Remark").val(data.Remark);
 $("#Qty").val(data.QtyMat);
 $("#QtyBefore").val(data.QtyMat);
 $("#NG").val(data.NGMatPcs);
 $("#NGBefore").val(data.NGMatPcs);
 }  });  };
...
function Detail_data2(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/INWip/DataDetailMatIn2",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
...
function hitung(){
 ...
 var StockWIP2 = $("#StockWIP2").val();
 var Qty = $("#Qty").val();
 var QtyBefore = $("#QtyBefore").val();
 var NG = $("#NG").val();
 var NGBefore = $("#NGBefore").val();
 var Yield = $("#Yield").val();
  
  var Yield = parseFloat(Qty) - parseFloat(NG) ;
  $("#Yield").val(Yield);

  var Balance = (parseFloat(StockWIP2) - (parseFloat(QtyBefore)-parseFloat(NGBefore))) + parseFloat(Yield) ;
  $("#Balance").val(Balance);
...
$("#Qty").keyup(function(){ hitung(); });
$("#NG").keyup(function(){ hitung(); });
...
function AmbilForm(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/ref_json/InfoTambahFormWIPIn",
 data	: "kode="+kode,
 cache	: false,
 dataType : "json",
 success	: function(data){
...
function AmbilFormDetail(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/ref_json/InfoTambahFormDetailWIPIn",
 data	: "kode="+kode,
 cache	: false,
 dataType : "json",
 success	: function(data){
...
function Detail_data(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/INWip/DataDetailMatIn",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
...
$("#Save").click(function(){
 ...
 if(Balance<0){ NotifFail('Qty Stock Minus'); return false(); }
 if(parseFloat(Qty) < parseFloat(NG)){ NotifFail('NG tidak boleh lebih besar dari Qty');  return false(); }
 var win = waitingDialog3.show('Processing ...', {dialogSize: 'sm', progressType: 'warning'}); 
  $.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/INWip/SimpanMaterialIn",
 data	: string,
 cache	: false,
 success	: function(data){
 setTimeout(function(){
...
$("#Search").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/INWip/ReadReport",
 data	: string,
 cache	: false,
 success	: function(data){
 setTimeout(function(){
...
$("#Download3").button('reset'); }, 1000);
 ...
 window.open('<?php echo site_url();?>/INWip/ExportReport/'+string); 
...
$("#PrintList3").button('reset'); }, 1000);
 ...
 window.open('<?php echo site_url();?>/INWip/PrintList2/'+string , 'myWindow', 
'status = 1, height = 650, width = 1100, resizable = 0, toolbar=no, location=no, status=no&#39, menubar=no, address bar=no' );
        ...
        function BackHome(){
        window.location.replace("<?php echo base_url();?>index.php/INWip/");
        }
...
$("#HapusDetail").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/INWip/Hapus_Transaksi",
...
$("#PrintList1").click(function(){
 var kode	= $("#DocNum").val();
 window.open('<?php echo site_url();?>/INWip/PrintList/'+kode , 'myWindow', 
 'status = 1, height = 650, width = 1100, resizable = 0, toolbar=no, location=no, status=no&#39, menubar=no, address bar=no' );
 return false(); });
...
$("#Download2").click(function(){
 ...
 window.open('<?php echo site_url();?>/INWip/ExportList/'+kode); 
 return false(); });
...
function MasterList(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/INWip/MasterList",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
 setTimeout(function() {
...
function List_Material(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/INWip/DataDetailMatIn3",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
 setTimeout(function() {
...
<div class="box">
<div class="box-body">
<?php  $cek = $this->Role_Model->TrcWIPView(); if(!empty($cek)){ ?>
...
<div class="form-group">
<label class="col-lg-4 control-label">Total OK</label>
<div class="col-lg-8">
<input type="text" id="Yield" name="Yield"  class="form-control" value="0" readonly="true">
</div> </div>
...
<div class="col-lg-4">
<input type="text" id="NGBefore" name="NGBefore"  class="form-control" value="0" readonly="true">
</div> </div>
...
<div class="col-xs-4">
<input type="text" id="Qty" name="Qty"  class="form-control" value="0" placeholder="Qty Masuk">
</div>
<div class="col-xs-4">
<input type="text" id="NG" name="NG"  class="form-control" value="0" placeholder="Qty NG">
</div> </div>
<div class="form-group">
