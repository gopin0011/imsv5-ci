 ...
 $.ajax({
        ...
        success	: function(data)
        {
            ...
            if(ada < 1){
                ...
                $.ajax({
                    type	: 'POST',
                    url		: "<?php echo site_url(); ?>/SuratJalanAll/GetAllUnit",
                    cache	: false,
                    dataType : "json",
                    success	: function(d)
                    {
