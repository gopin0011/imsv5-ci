        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <select id="PartnerID" name="PartnerID" class="form-control" style="width: 100%;">
                	...
                	<option value="<?php echo $t->SysID;?>" selected="selected"><?php echo $t->PartnerName;?></option>
                	<?php }else { ?>
                	<option value="<?php echo $t->SysID;?>"><?php echo $t->PartnerName;?></option>
                	<?php } } ?>  
                </select>
            </div>
            <div class="col-sm-5">
...
$('#datetimepicker3').datetimepicker({
 ...
 $('#PartnerID').on('change',function(){
           ...
           if(this.value!="")
           {
               $.ajax({
                    type	: 'POST',
                    url		: "<?php echo site_url(); ?>/SuratJalanAll/GetInfoPartner",
                    data	: "SysID="+this.value,
                    cache	: false,
                    dataType : "json",
                    success	: function(data)
                    {
                        $('#PartnerName').val(data[0].PartnerName+' - '+data[0].PartnerCode);
