...
<?php
    ...
    {
        echo "<br>";
        echo '<table width="100%"><tr><td width="50%" colspan="3">';
        ...
        echo '<td width="50%" colspan="3"><div class="images"><br><br><br><p>page: '.$page.' of '.$ofPage.'</p></div></td></tr></table>';
        echo '<br><br><table width="100%" class="header">';
        echo '<tr><td width="50%" colspan="4"><h2>Delivery Note</h2><span style="margin-left:200;">User: '.$username.'</span></td>';
        ...
        echo '<tr><td rowspan="3" colspan="4"><span class="label1">Ship to:</span><h4 class="partner">'.$PartnerName.'</h4><br>'.$DlvAddress.'<br><br></td>';
    ...
    {	
        ...
        echo '<td align="center" colspan="3">Transfered Legalization</td></tr>';
        ...
        echo '<td colspan="3">Time Out: '.$ShipTime.'</td></tr>';
        echo '<tr><td style="border-right:none;" colspan="2">Received By<br><br><br><br>Name Occupation:</td><td style="border-left:none; vertical-align:top;">Signature & Comp. Stamp</td></tr>';
        echo '</table>';
    ...
    header("Content-Disposition: attachment; filename=SuratJalan".$head->DocDate.".xls");
    header("Pragma: no-cache");
    header("Expires: 0");
?>

<!-- end ExportListReport.view -->