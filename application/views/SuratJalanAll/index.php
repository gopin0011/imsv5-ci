    ...
    $(document).ready(function()
    {
       ion.sound({
        ...
        function tampil_data()
        {
            ...
            $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/SuratJalanAll/TransactionList",
                data	: "kode="+kode,
                cache	: false,
        ...
        function Detail_data()
        {
            ...
            $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/SuratJalanAll/DetailData",
                data	: "kode="+kode,
                cache	: false,
                success	: function(data)
                {
        ...
        function AmbilForm()
        {
            ...
            $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/SuratJalanAll/InfoTambahFormInFG",
                data	: "kode="+kode,
                cache	: false,
                dataType : "json",
                success	: function(data)
        ...
        $('#simpan').click(function(){
           ...
           else 
           {
            ...
            $.ajax({
                type	: 'POST',
                url	: "<?php echo site_url(); ?>/SuratJalanAll/simpan",
                data	: string,
                cache	: false,
                success	: function(data){
                setTimeout(function(){
        ...
        {
            var kode	= $("#DocNum").val();
            window.open('<?php echo site_url();?>/SuratJalanAll/PrintList/'+kode , 'myWindow', 
        ...
        function Detail_data2()
        {
            ...
            $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/SuratJalanAll/GetData",
                data	: "kode="+kode,
                cache	: false,
                success	: function(data){
            ...
            $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/SuratJalanAll/DataDetailMatIn2",
                data	: "kode="+kode,
                cache	: false,
                success	: function(data){
        ...
        $('#PrintList2').click(function(){
           window.open('<?php echo site_url();?>/SuratJalanAll/PrintList/'+$(this).attr('data-ref'),'',' scrollbars=yes,menubar=no,width=1100,height=600, resizable=yes,toolbar=no,location=no,status=no'); 
        });
        ...
        function MasterList2()
        {
            ...
            $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/SuratJalanAll/MasterList2",
                data	: "kode="+kode,
                cache	: false,
                success	: function(data)
                {
        ...
        $("#Search").click(function()
        {
            ...
            $.ajax({
                type	 : 'POST',
                url	 : "<?php echo site_url(); ?>/SuratJalanAll/ReadReport",
                data	 : string,
                cache	: false,
                success	: function(data){
                setTimeout(function()
        ...
        $('#PrintList3').click(function(){
            ...
            window.open('<?php echo site_url();?>/SuratJalanAll/PrintListReport/'+string , 'myWindow', 
            'status = 1, height = 650, width = 1100, resizable = 0, toolbar=no, location=no, status=no&#39, menubar=no, address bar=no' );
            return false();
        });
        ...
        $('#ExportList').click(function(){
            ...
            window.open('<?php echo site_url();?>/SuratJalanAll/ExportReport/'+string); 
            return false();
        });
...
<script>
    ...
    function cari_docnum()
    {
        ...
        $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/SuratJalanAll/GetDocNumReport",
                data	: "DocNum="+val,
                cache	: false,
                success	: function(data)
                {
...
<script>
    function proses_confirm(obj,status)
    {
        ...
        $.ajax({
            type	: 'POST',
            url		: "<?php echo site_url(); ?>/SuratJalanAll/update_confirm/",
