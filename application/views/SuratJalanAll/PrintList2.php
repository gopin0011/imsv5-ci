...
<?php
    ...
    if($head->username == 'Quality') $head->username = 'Alex / Slamet';
    ...
    {	
        ...
        echo '<tr><td width="16%" align="center" rowspan="2">Transfered<br>By<hr style="height:35px; visibility:hidden;" /><u>'.$username.'</u><br>'.$dept.'</td><td width="18%" align="center" rowspan="2">Approve<br>By<hr style="height:35px; visibility:hidden;" /><u>'.$SectionHead.'</u>&nbsp;<br>Sec/Div. Head</td><td width="16%" align="center" rowspan="2">Delivered By<hr style="height:35px; visibility:hidden;" /><u>'.$DriverName.'</u>&nbsp;<br>Driver</td>';
    ...
    {	
        ...
        echo '<table width="100%" class="footer"><tr><td align="center" colspan="3">Transfered Legalization</td>';
        echo '<td align="center" colspan="2">Transfered Legalization</td></tr>';
        echo '<tr><td width="16%" align="center" rowspan="2">Transfered<br>By<hr style="height:35px; visibility:hidden;" /><u>'.$username.'</u><br>'.$dept.'</td><td width="18%" align="center" rowspan="2">Approve<br>By<hr style="height:35px; visibility:hidden;" /><u>'.$SectionHead.'</u>&nbsp;<br>Sec/Div. Head</td><td width="16%" align="center" rowspan="2">Delivered<br>By<hr style="height:35px; visibility:hidden;" /><u>'.$DriverName.'</u>&nbsp;<br>Driver</td>';
        echo '<td colspan="2" style="border-right:none;">Time Out: '.$ShipTime.'</td></tr>';
        echo '<tr><td style="border-right:none">Received By<hr style="height:25px; visibility:hidden;" />Name Occupation:</td><td style="border-left:none; vertical-align:top;">Signature & Comp. Stamp</td></tr>';
        echo '</table>';  
        echo "<div style='width:100%;text-align:right;'><span>Print Date: <b>".date('d-m-Y')."</b></span></div>";
    ...
    foreach($data as $row)
    {
        ...
        echo '<tr class="isi">
                ...
                <td>'.$row->PartName.'<br>'.$row->PartNo.'</td>
                <td>'.$row->JobNumber.'</td>
