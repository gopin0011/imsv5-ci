...
{
    //window.open('<?php echo site_url();?>/SuratJalan/PrintList2/'+RegID,'',' scrollbars=yes,menubar=no,width=1100,height=600, resizable=yes,toolbar=no,location=no,status=no');
    waitingDialog3.show('Processing ...', {dialogSize: 'sm', progressType: 'warning'});
    $.ajax({
        type	: 'POST',
        url		: "<?php echo site_url(); ?>/SuratJalan/PrintList2/",
        data	: "RegID="+RegID,
        cache	: false,
