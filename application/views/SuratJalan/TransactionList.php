...
{
    window.open('<?php echo site_url();?>/SuratJalan/PrintList/'+RegID,'',' scrollbars=yes,menubar=no,width=1100,height=600, resizable=yes,toolbar=no,location=no,status=no');
}
</script>
