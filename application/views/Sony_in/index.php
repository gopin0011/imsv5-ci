...
window.open('<?php echo site_url();?>/Sony_in/print_list/'+kode , 'myWindow', 
...
function AmbilForm(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Sony_in/RegDocNumSony_Head",
			data	: "kode="+kode,
			cache	: false,
			dataType : "json",
...
function AmbilFormDetail(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Sony_in/RegDocNumSony_Detail",
			data	: "kode="+kode,
			cache	: false,
			dataType : "json",
			success	: function(data){
...
function AmbilFormAdd(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Sony_in/RegDocNumSony_Add",
			data	: "id="+id,
			cache	: false,
			dataType : "json",
			success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Sony_in/transaction_list",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Sony_in/transaction_detail",
data	: "id="+id,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Sony_in/transaction_detail_2",
data	: "id="+id,
cache	: false,
success	: function(data){
...
return false();	}
if(Qty_2.length==0){
NotifFail('Qty harus di isi !!!');
ion.sound.play("metal_plate");
$("#RefNum").val("");
return false();	}

if(RefNum.length==0){
NotifFail('Barcode harus di isi !!!');
ion.sound.play("metal_plate");
$("#RefNum").val("");
return false();	}
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Sony_in/Save",
data	: "&DocNum="+DocNum+"&DocNumDetail="+DocNumDetail+"&SysID="+SysID+"&DocDate="+DocDate+"&QCCheckID="+QCCheckID+"&RefNum="+RefNum+"&ShiftID="+ShiftID+"&Qty_2="+Qty_2+"&RefNum_D="+RefNum_D,
cache	: false,
success	: function(data){
setTimeout(function(){
NotifSuccsess(data);
...
NotifFail('Server tidak merespon :'+kesalahan);	}		
   ...
   function NotifFail(data){
	...
	function CariProfilProduct(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Sony_in/InfoMaterial_product",
			data	: "kode="+kode,
			cache	: false,
			dataType : "json",
			success	: function(data){
...
$("#HapusDetail").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Sony_in/Hapus_Detail",
 ...
 $("#HapusDetail2").click(function(){
    ...
    $("#export_list").click(function(){
		...
		window.open('<?php echo site_url();?>/Sony_in/export_list/'+string);
		return false();	
	});
...
$("#export_list3").click(function(){
       var ShiftIDReport = $("#ShiftIDReport").val();
		...
		window.open('<?php echo site_url();?>/Sony_in/export_list_report/'+string);
		return false();	
	});
...
window.open('<?php echo site_url();?>/Sony_in/print_list_report/'+string , 'myWindow', 
'status = 1, height = 650, width = 1100, resizable = 0, toolbar=no, location=no, status=no&#39, menubar=no, address bar=no' );
return false(); });    
    ...
    $("#Search").click(function(){
		...
		if(DocDateReport_1.length==0){
		 ...
		 $.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Sony_in/ReadReport",
			data	: string,
			cache	: false,
			success	: function(data){
				setTimeout(function(){
...
<label class="col-xs-4 control-label">Barcode ID</label>
<div class="col-xs-8">
...
<div class="col-xs-4">
<input type="number" min="1" max="4" id="Qty_2" name="Qty_2" class="form-control" required="" value="4">
</div>
<div class="col-xs-4">
<input type="text" class="form-control" required="" value="Unit" readonly="" style="border: none;">
</div>
</div>             
...
<div class="col-xs-8">
<input type="text" id="RefNum_D" name="RefNum_D" class="form-control">
</div>
</div>
