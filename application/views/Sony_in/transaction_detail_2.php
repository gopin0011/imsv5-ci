...
<button type="button" onfocus="HapusDetail_2('<?php echo $row->DocNumDetail ; ?>','<?php echo $row->PartNo ; ?> (<?php echo $row->DocNum_Ext ; ?>)')" class="btn btn-xs" href="#tab_content1" data-toggle="tab" aria-expanded="false" >
