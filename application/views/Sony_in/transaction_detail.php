...
<td align="right" width="60"><?php echo $Total ; ?> - Unit</td>
...
<button type="button" onfocus="HapusDetail('<?php echo $row->DocNumDetail ; ?>','<?php echo $row->PartNo ; ?> (<?php echo $row->DocNum_Ext ; ?>)')" class="btn btn-xs" href="#tab_content1" data-toggle="tab" aria-expanded="false" >
<i class="glyphicon glyphicon-trash"></i> </button><?php } ?>
...
function HapusDetail(SysID,PartNo){
