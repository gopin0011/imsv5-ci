...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/MasterProdStamping/ListProduct",
data	: "&id="+id,
cache	: false,
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/MasterProdStamping/ConectingBomList",
data	: "&id="+id,
cache	: false,
success	: function(data){
...
$("#Save").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/MasterProdStamping/Save",
 data	: string,
 cache	: false,
 success	: function(data){
 NotifSuccsess(data);
...
$("#Hapus").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/MasterProdStamping/Hapus_Product",
 data	: string,
 cache	: false,
 success	: function(data){
 NotifSuccsess(data);
...
function MasterList(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/MasterProdStamping/ListProduct1",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
 setTimeout(function() {
...
<?php  $cek = $this->Role_Model->MProdStampingUp(); if(!empty($cek)){ ?>
...
<div class="box">
<div class="box-body">
<?php  $cek = $this->Role_Model->MProdStampingView(); if(!empty($cek)){ ?>
...
<input type="text" id="PcsPerDay" name="PcsPerDay"  class="form-control" placeholder="Kebutuhan Per Hari">
 ...
 <?php  $cek = $this->Role_Model->MProdStampingDel(); if(!empty($cek)){ ?>
...
$.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/MasterProdStamping/SelectBOM",
...
$.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/MasterProdStamping/DeleteConecting",
 data	: "&SysID="+SysID,
 cache	: false,
 success	: function(data){
