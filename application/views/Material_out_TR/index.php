...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_out_TR/transaction_list",
data	: "kode="+kode,
cache	: false,
...
function AmbilFormEdit(){
 ...
 $("#DocNumDetail").val(data.DocNumDetailTROUT);
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_out_TR/transaction_detail_2",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_out_TR/transaction_detail",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_out_TR/List_Material",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
function AmbilForm(){
 ...
 $.ajax({
 type : 'POST',
 url : "<?php echo site_url(); ?>/ref_json/InfoTambahFormTRMatOut",
 data : "kode="+kode,
 cache : false,
 dataType : "json",
 success	: function(data){
 ...
 $("#PicName").val("");
   ...
   function AmbilFormDetail(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/ref_json/InfoTambahFormDetailTRMatOut",
			data	: "kode="+kode,
			cache	: false,
			dataType : "json",
			success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_out_TR/InfoMaterial_product",
data	: "kode="+kode,
cache	: false,
dataType : "json",
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_out_TR/InfoPartner",
data	: "kode="+kode,
cache	: false,
dataType : "json",
success	: function(data){
...
$("#Save").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/Material_out_TR/Save",
 data	: string,
 cache	: false,
 success	: function(data){
 setTimeout(function(){
...
$("#Search").click(function(){
 ...
 $.ajax({
 type	 : 'POST',
 url	 : "<?php echo site_url(); ?>/Material_out_TR/ReadReport",
 data	 : string,
 cache	: false,
 success	: function(data){
 setTimeout(function(){
...
$("#ExportList3").click(function(){
 ...
 window.open('<?php echo site_url();?>/Material_out_TR/ExportReport/'+string); return false(); });
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_out_TR/Hapus_Detail",
...
$("#pesan4").text('Server tidak merespon :'+kesalahan); } 	}); return false();	 });
 ...
 $this.button('reset');
 var kode	= $("#DocNum2").val();
 window.open('<?php echo site_url();?>/Material_out_TR/PrintList/'+kode);
 return false();	
 }, 500); });
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_out_TR/MasterList",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_out_TR/MasterList2",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_out_TR/MasterListPic",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
<div class="box">
<div class="box-body">
<?php $cek = $this->Role_Model->TrcStoreRoomView(); if(!empty($cek)){ ?>
...
<div class="col-xs-4">
<input type="text" id="QtyMat" name="QtyMat"  class="form-control" value="0" placeholder="Jangan Dihapus">
</div>
<div class="col-xs-4">
