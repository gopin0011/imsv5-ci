...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_in_TR/transaction_list",
data	: "kode="+kode,
cache	: false,
...
function AmbilFormEdit(){
 ...
 $("#DocNumDetail").val(data.DocNumDetailTR);
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_in_TR/transaction_detail_2",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_in_TR/transaction_detail",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_in_TR/List_Material",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$("#form-tab").click(function(){
   ...
   function AmbilForm(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Material_in_TR/InfoTambahFormTRMatIn",
			data	: "kode="+kode,
			cache	: false,
			dataType : "json",
			success	: function(data){
   ...
   function AmbilFormDetail(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Material_in_TR/InfoTambahFormDetailTRMatIN",
			data	: "kode="+kode,
			cache	: false,
			dataType : "json",
			success	: function(data){
    ...
    function CariProfilProduct2(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Material_in_TR/InfoMaterial_product",
			data	: "kode="+kode,
			cache	: false,
			dataType : "json",
			success	: function(data){
...
$("#Save").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/Material_in_TR/Save",
 data	: string,
 cache	: false,
 success	: function(data){
 setTimeout(function(){
...
$("#Search").click(function(){
 ...
 $.ajax({
 type	 : 'POST',
 url	 : "<?php echo site_url(); ?>/Material_in_TR/ReadReport",
 data	 : string,
 cache	: false,
 success	: function(data){
 setTimeout(function(){
...
$("#ExportList3").click(function(){
 ...
 window.open('<?php echo site_url();?>/Material_in_TR/ExportReport/'+string); return false(); });
 ...
 $("#HapusDetail").click(function(){
	...
	$.ajax({
	type	: 'POST',
	url		: "<?php echo site_url(); ?>/Material_in_TR/Hapus_Detail",
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_in_TR/MasterList",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_in_TR/MasterList2",
data	: "kode="+kode,
cache	: false,
success	: function(data){
