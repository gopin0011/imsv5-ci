...
function ConectingChildPart(){
var id = $("#ItemID").val() ;
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/MasterProdWeld/ConectingChildPart",
data	: "&id="+id,
cache	: false,
success	: function(data){
$("#ConectingChildPart").html(data);
} }); };
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/MasterProdWeld/ConectingBomList",
data	: "&id="+id,
cache	: false,
success	: function(data){
...
$("#PartNo").focus(function(e){ var isi = $(e.target).val(); CariProfilProduct(); ConectingChildPart(); ConectingBomList();});
...
function MasterList2(){
 ...
 $("#AddChildPart").click(function(){ $("#myModal_product").modal('show'); MasterList(); });
 $("#AddActivity").click(function(){ $("#myModal_product2").modal('show'); MasterList2(); });
 });	
</script>
...
<?php  $cek = $this->Role_Model->MProdWeldingUp(); if(!empty($cek)){ ?>
...
<div class="box">
<div class="box-body">
<?php  $cek = $this->Role_Model->MProdWeldingView(); if(!empty($cek)){ ?>
...
<input type="text" id="PcsPerday" name="PcsPerday"  class="form-control" value="0" placeholder="Kebutuhan Per Hari">
 ...
 <?php  $cek = $this->Role_Model->MProdWeldingDel(); if(!empty($cek)){ ?>
...
<div class="btn-group">
<button type="button" class="btn btn-success" id="AddChildPart">
<i class="fa fa-plus"></i>&nbsp; Add Child Part</button>
</div>
</div>
...
$("#AddChildPart").button('loading');
$("#myModal_product").modal('hide');
var ItemID = $("#ItemID").val() ;
$.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/MasterProdWeld/SelectBOM",
 data	: "&SysID="+SysID+"&ItemID="+ItemID+"&PartTypeID="+PartTypeID,
 cache	: false,
 success	: function(data){
 ConectingChildPart2();
 setTimeout(function() {  $("#AddChildPart").button('reset'); }, 500) ;
 	} }); return false(); };

 function SelectBOM2(SysID,PartTypeID){
$("#AddActivity").button('loading');
$("#myModal_product2").modal('hide');
var ItemID = $("#ItemID").val() ;
$.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/MasterProdWeld/SelectBOM2",
 data	: "&SysID="+SysID+"&ItemID="+ItemID+"&PartTypeID="+PartTypeID,
 cache	: false,
 success	: function(data){
 ConectingBomList2();
...
$.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/MasterProdWeld/DeleteConecting",
 data	: "&SysID="+SysID,
 cache	: false,
 success	: function(data){
 setTimeout(function() {  ConectingChildPart2();  }, 500) ;
 	} }); return false(); };

function ActionDelete2(SysID){
$("#Del2_"+SysID).button('loading');
$.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/MasterProdWeld/DeleteConecting2",
 data	: "&SysID="+SysID,
 cache	: false,
 success	: function(data){
