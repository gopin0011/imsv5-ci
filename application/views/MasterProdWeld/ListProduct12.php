<table id="t_list_master12" class="table table-bordered table-striped">
<thead>
<tr class="headings">
    <th>PartNo</th>  
    <th>PartName</th>  
...
?>    
<tr class="odd gradeX" style="cursor:pointer" onclick="javascript:pilih12('<?php echo $row->RegID;?>')">
...
<script> $(function () { $("#t_list_master12").DataTable(); });</script>