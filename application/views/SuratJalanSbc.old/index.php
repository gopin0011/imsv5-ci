...
<script>
    ...
    $(document).ready(function()
    {
        ...
        function tampil_data()
        {
            ...
            $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/SuratJalanSbc/TransactionList",
                data	: "kode="+kode,
                cache	: false,
        ...
        function Detail_data()
        {
            ...
            $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/SuratJalanSbc/DetailData",
                data	: "kode="+kode,
                cache	: false,
                success	: function(data)
                {
        ...
        function AmbilForm()
        {
            ...
            $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/SuratJalanSbc/InfoTambahFormInFG",
                data	: "kode="+kode,
                cache	: false,
                dataType : "json",
                success	: function(data)
        ...
        $('#simpan').click(function(){
           ...
           else 
           {
            ...
            $.ajax({
                type	: 'POST',
                url	: "<?php echo site_url(); ?>/SuratJalanSbc/simpan",
                data	: string,
                cache	: false,
                success	: function(data){
                setTimeout(function(){
        ...
        {
            var kode	= $("#DocNum").val();
            window.open('<?php echo site_url();?>/SuratJalanSbc/PrintList/'+kode , 'myWindow', 
        ...
        $('#PrintList2').click(function(){
           window.open('<?php echo site_url();?>/SuratJalanSbc/PrintList/'+$(this).attr('data-ref'),'',' scrollbars=yes,menubar=no,width=1100,height=600, resizable=yes,toolbar=no,location=no,status=no'); 
        });
        ...
        function MasterList2()
        {
            ...
            $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/SuratJalanSbc/MasterList2",
                data	: "kode="+kode,
                cache	: false,
                success	: function(data)
                {
        ...
        $("#Search").click(function()
        {
            ...
            var tgl1 = $("#tgl1").val();
            var tgl2 = $("#tgl2").val();
            var string = "&tgl1="+tgl1+"&tgl2="+tgl2+"&ItemID2="+ItemID2;
            ...
            $.ajax({
                type	 : 'POST',
                url	 : "<?php echo site_url(); ?>/SuratJalanSbc/ReadReport",
                data	 : string,
                cache	: false,
                success	: function(data){
                setTimeout(function()
        ...
        $('#PrintList3').click(function(){
            ...
            window.open('<?php echo site_url();?>/SuratJalanSbc/PrintListReport/'+string , 'myWindow', 
            'status = 1, height = 650, width = 1100, resizable = 0, toolbar=no, location=no, status=no&#39, menubar=no, address bar=no' );
            return false();
        });
    });
...
<script>
    ...
    function cari_docnum()
    {
        ...
        $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/SuratJalanSbc/GetDocNumReport",
                data	: "DocNum="+val,
                cache	: false,
                success	: function(data)
                {
...
<script>
    function proses_confirm(obj,status)
    {
        ...
        $.ajax({
            type	: 'POST',
            url		: "<?php echo site_url(); ?>/SuratJalanSbc/update_confirm/",
