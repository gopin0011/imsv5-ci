...
<tr>
 ...
 <td align="left" width="80" ><span id="EditStock_<?php echo $row->ItemID;?>"><?php $cek = $this->Role_Model->TrcICTUp(); if(!empty($cek)) { ?><a href="javascript:void(0);" onclick="editBal(this,'<?php echo $row->StockWIP2 ; ?>');" data-ref="<?php echo $row->ItemID;?>"><?php echo $row->StockWIP2 ; ?> </a><?php } else { echo $row->StockWIP2; } ?></span></td>
