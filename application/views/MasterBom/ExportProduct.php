...
foreach($data as $db){
            ...
            $LevelPart1_db = $db->level; 
            if($LevelPart1_db==0){$LevelPart1 = 1 ;}else{$LevelPart1 = '' ;}
            $LevelPart2_db = $db->level; 
            if($LevelPart2_db==1){$LevelPart2 = 2 ;}else{$LevelPart2 = '' ;}
            $LevelPart3_db = $db->level; 
            if($LevelPart3_db==2){$LevelPart3 = 3 ;}else{$LevelPart3 = '' ;}
            $LevelPart4_db = $db->level; 
            if($LevelPart4_db==3){$LevelPart4 = 4 ;}else{$LevelPart4 = '' ;}
            $ItemNo_db = $db->ItemNo; if($ItemNo_db==0){$ItemNo = '';}else{$ItemNo = $ItemNo_db ;}
            //$ItemNoSub_db = $db[$i]['ItemNoSub'] ; if($ItemNoSub_db == 0){$ItemNoSub = '';}else{$ItemNoSub = ".". $ItemNoSub_db  ;}
            //if($ItemNoSub_db==0 && $ItemNo_db>0){$head = 'style="background: cyan;"' ;}else{$head = '' ;}
            
            //$ItemNo = '';
            $head = ($db->level == 0) ? 'style="background: cyan;"':'';
