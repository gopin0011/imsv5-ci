...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_in_GA/transaction_list",
data	: "kode="+kode,
cache	: false,
...
function AmbilFormEdit(){
 ...
 $("#DocNumDetail").val(data.DocNumDetailGAIn);
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_in_GA/transaction_detail_2",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_in_GA/transaction_detail",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_in_GA/List_Material",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$("#form-tab").click(function(){
   ...
   function AmbilForm(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/ref_json/InfoTambahFormGAMatIn",
			data	: "kode="+kode,
			cache	: false,
			dataType : "json",
			success	: function(data){
   ...
   function AmbilFormDetail(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/ref_json/InfoTambahFormDetailGAMatIN",
			data	: "kode="+kode,
			cache	: false,
			dataType : "json",
			success	: function(data){
    ...
    function CariProfilProduct2(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Material_in_GA/InfoMaterial_product",
			data	: "kode="+kode,
			cache	: false,
			dataType : "json",
			success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_in_GA/InfoPartner",
data	: "kode="+kode,
cache	: false,
dataType : "json",
success	: function(data){
...
$("#Save").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/Material_in_GA/Save",
 data	: string,
 cache	: false,
 success	: function(data){
 setTimeout(function(){
...
$("#Search").click(function(){
 ...
 $.ajax({
 type	 : 'POST',
 url	 : "<?php echo site_url(); ?>/Material_in_GA/ReadReport",
 data	 : string,
 cache	: false,
 success	: function(data){
 setTimeout(function(){
...
$("#ExportList3").click(function(){
 ...
 window.open('<?php echo site_url();?>/Material_in_GA/ExportReport/'+string); return false(); });
 ...
 $("#HapusDetail").click(function(){
	...
	$.ajax({
	type	: 'POST',
	url		: "<?php echo site_url(); ?>/Material_in_GA/Hapus_Detail",
 ...
 $this.button('reset');
 var kode	= $("#DocNum2").val();
 window.open('<?php echo site_url();?>/Material_in_GA/PrintList/'+kode);
 return false();	
 }, 500); });
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_in_GA/MasterList",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_in_GA/MasterList2",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_in_GA/MasterListPartner",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$("#partner_code").click(function(){ $("#myModal_Partner").modal('show'); MasterListPartner(); });
...
<?php $cek = $this->Role_Model->TrcGAUp(); if(!empty($cek)){ ?>
...
<div class="box">
<div class="box-body">
<?php $cek = $this->Role_Model->TrcGAView(); if(!empty($cek)){ ?>
<div id="transaction_list"></div><?php } ?>
</div></div></div></div>
...
<input type="text" id="Category" name="Category"  class="form-control" readonly="readonly">
    ...
    <div class="form-group">
<label class="col-xs-4 control-label">PO No.</label>
<div class="col-xs-4">
<input type="text" id="PONum" name="PONum"  class="form-control" placeholder="No PO">
</div>
<div class="col-xs-4">
<input type="text" id="Amount" name="Amount"  class="form-control" placeholder="Harga Total" readonly="readonly">
</div>
</div>
...
<div class="form-group">
<label class="col-xs-4 control-label">SJ No.</label>
<div class="col-xs-8">
<input type="text" id="SJNum" name="SJNum"  class="form-control" >
</div>
</div>
<div class="form-group">
