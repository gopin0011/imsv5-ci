...
$kanan = "
  <tr>
    ...
    <td class='tg-efv9' style='border-right: none; border-bottom: none;'>Filter</td>
    <td class='tg-8fc1' style='border-left: none; border-bottom: none;'>: ".$Filter."</td>
    <td class='tg-lntm' colspan='5' rowspan='3'>Report - Return</td>
  </tr>
  <tr>
    <td class='tg-efv9' style='border-right: none;border-top: none; border-bottom: none;'>Shift</td>
    <td class='tg-8fc1' style='border-left: none; border-top: none; border-bottom: none;'>: ".$Shift." </td>
  </tr>
  <tr>
    <td class='tg-l77s' style='border-top: none;' colspan='2'>PT SUMMIT ADYAWINSA INDONESIA</td>
    <td class='tg-efv9' style='border-right: none;border-top: none; border-bottom: none;'></td>
...
<col style='width: 100px'>
 ...
 <?php echo $kanan ;?>
  ...
  <tr>
    ...
    <th class="tg-l77s" colspan="2">Barcode ID</th>
    <th class="tg-l77s" colspan="2">Product</th>
    <th class="tg-a2cf" colspan="3">Log</th>
...
foreach($data as $row){  
$Total = $row->Qty_2 ;
$DocDate = $this->Sony_in_model->tgl_str($row->DocDate) ; 
$DocDate2 = $this->Sony_in_model->tgl_str($row->DocDate) ;
$CreateDate = $this->Sony_in_model->tgl_str($row->CreateDate) ; 
$DocNum = md5($row->DocNum) ;
    ...
    <td class="tg-h31u" colspan="2"><?php echo $row->DocNum_Ext ; ?></td>
    <td class="tg-h31u" colspan="2"><?php echo $row->PartNo ; ?> - <?php echo $row->PartName ; ?></td>
    <td class="tg-h31u1" colspan="3"><?php echo $CreateDate ; ?> <?php echo $row->DocTime ; ?></td>
    <td class="tg-h31u1"><?php echo $Total ; ?> - Unit</td>
  </tr>
