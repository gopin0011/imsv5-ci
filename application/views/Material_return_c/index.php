...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_return/InfoDataEdit",
data	: "kode="+kode,
cache	: false,
dataType : "json",
...
$("#Add_2").click(function(){
  ...
  $this.button('loading');
    ...
    function AmbilForm(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Material_return/InfoTambahFormMatOut",
			data	: "kode="+kode,
			cache	: false,
			dataType : "json",
			success	: function(data){
...
function AmbilFormDetail(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Material_return/InfoTambahFormDetailMatIN",
			data	: "kode="+kode,
			cache	: false,
			dataType : "json",
			success	: function(data){
...
function AmbilFormAdd(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Material_return/RegDocNumSony_Add",
			data	: "id="+id,
			cache	: false,
			dataType : "json",
			success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_return/transaction_list",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_return/transaction_detail",
data	: "id="+id,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_return/transaction_detail_2",
data	: "id="+id,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_return/List_Material",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_return/Save",
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_return/Hapus_Detail",
...
$("#DocNumDetail2Search").focus(function(e){
    ...
    function AmbilFormSearch(){
		...
		if(DocDateReport_1.length==0){
		 ...
		 $.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Material_return/ReadReport",
			data	: string,
			cache	: false,
			success	: function(data){
			setTimeout(function(){
   ...
   $("#cetak").click(function(){
        ...
        window.open('<?php echo site_url();?>/Material_return/ExportReport/'+string); return false();	 });
    ...
    $("#Print4").click(function(){
		...
		window.open('<?php echo site_url();?>/Material_return/PrintList2/'+string , 'myWindow', 
...
var kode	= $("#DocNum").val();
window.open('<?php echo site_url();?>/Material_return/DetailPrint/'+kode , 'myWindow', 
'status = 1, height = 650, width = 1100, resizable = 0, toolbar=no, location=no, status=no&#39, menubar=no, address bar=no' );
return false();
});
...
'status = 1, height = 650, width = 1100, resizable = 0, toolbar=no, location=no, status=no&#39, menubar=no, address bar=no' );
    ...
    $("#Print3").click(function(){
		var kode	= $("#DocNum2").val();
		window.open('<?php echo site_url();?>/Material_return/PrintList/'+kode , 'myWindow', 
'status = 1, height = 650, width = 1100, resizable = 0, toolbar=no, location=no, status=no&#39, menubar=no, address bar=no' );
		return false();
	});
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Material_return/MasterList",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
var DocNumDetail3 = $("#DocNumDetail3").val();
if(DocNumDetail3.length==0){
$("#myModal_MaterialList").modal('show');
return false(); } });
