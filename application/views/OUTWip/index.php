...
$('#reload').on('click', function() {
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/OUTWip/TransactionList",
 data	: "kode="+kode,
 cache	: false,
...
function Detail_data2(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/OUTWip/DataDetailMatIn2",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
...
function hitung(){
 ...
 var Yield = $("#Yield").val();
  ...
  var Balance = (parseFloat(StockWIP2) + parseFloat(QtyBefore)) - parseFloat(Qty) ;
  $("#Balance").val(Balance);
...
function AmbilForm(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/ref_json/InfoTambahFormWIPOut",
 data	: "kode="+kode,
 cache	: false,
 dataType : "json",
 success	: function(data){
...
function AmbilFormDetail(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/ref_json/InfoTambahFormDetailWIPOut",
 data	: "kode="+kode,
 cache	: false,
 dataType : "json",
 success	: function(data){
...
function Detail_data(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/OUTWip/DataDetailMatIn",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
...
$("#Save").click(function(){
 ...
 var win = waitingDialog3.show('Processing ...', {dialogSize: 'sm', progressType: 'warning'}); 
  $.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/OUTWip/SimpanMaterialIn",
 data	: string,
 cache	: false,
 success	: function(data){
 setTimeout(function(){
...
$("#Search").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/OUTWip/ReadReport",
 data	: string,
 cache	: false,
 success	: function(data){
 setTimeout(function(){
...
$("#Download3").button('reset'); }, 1000);
 window.open('<?php echo site_url();?>/OUTWip/ExportReport/'+string); 
...
$("#PrintList3").button('reset'); }, 1000);
 ...
 window.open('<?php echo site_url();?>/OUTWip/PrintList2/'+string , 'myWindow', 
'status = 1, height = 650, width = 1100, resizable = 0, toolbar=no, location=no, status=no&#39, menubar=no, address bar=no' );
        ...
        function BackHome(){
        window.location.replace("<?php echo base_url();?>index.php/OUTWip/");
        }
...
$("#HapusDetail").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/OUTWip/Hapus_Transaksi",
...
$("#PrintList1").click(function(){
 var kode	= $("#DocNum").val();
 window.open('<?php echo site_url();?>/OUTWip/PrintList/'+kode , 'myWindow', 
 'status = 1, height = 650, width = 1100, resizable = 0, toolbar=no, location=no, status=no&#39, menubar=no, address bar=no' );
 return false(); });
...
$("#Download2").click(function(){
 ...
 window.open('<?php echo site_url();?>/OUTWip/ExportList/'+kode); 
 return false(); });
...
function MasterList(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/OUTWip/MasterList",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
 setTimeout(function() {
...
function List_Material(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/OUTWip/DataDetailMatIn3",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
 setTimeout(function() {
