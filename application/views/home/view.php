...
<div id="myTabContent" class="tab-content">
 ...
 {
    ?>
    <p class="col-xs-12"><?php echo $row->coment ; ?></p>
    <?php
 }
 else
 {
 ...
 <img class="img-responsive img-circle img-sm" src="<?php echo base_url();?>images/foto_profil/<?php echo $this->session->userdata('Image'); ;?>" alt="Alt Text">
 <div class="img-push">
