...
?>
<tr class="odd gradeX" style="cursor: pointer;" onclick="javascript:PilihListTrc_d('<?php echo $row->RegID;?>','<?php echo $row->NewDocNum;?>')" href="#tab_content4" data-toggle="tab" aria-expanded="false" id="row_<?php echo $row->RegID;?>">
