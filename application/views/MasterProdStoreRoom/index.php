...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/MasterProdStoreRoom/ListProduct",
data	: "&id="+id,
cache	: false,
...
$("#Save").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/MasterProdStoreRoom/Save",
 data	: string,
 cache	: false,
 success	: function(data){
 NotifSuccsess(data);
...
$("#Hapus").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/MasterProdStoreRoom/Hapus_Product",
 data	: string,
 cache	: false,
 success	: function(data){
 NotifSuccsess(data);
...
<?php  $cek = $this->Role_Model->MProdStoreRoomUp(); if(!empty($cek)){ ?>
...
<div class="box">
<div class="box-body">
<?php  $cek = $this->Role_Model->MProdStoreRoomView(); if(!empty($cek)){ ?>
...
<input type="text" id="Max" name="Max"  class="form-control" placeholder="Max">
 ...
 <?php  $cek = $this->Role_Model->MProdStoreRoomDel(); if(!empty($cek)){ ?>
