...
<tr>
    ...
    <td class='tg-lntm' colspan='5' rowspan='3'>Material Received</td>
  </tr>
  <tr>
    <td class='tg-efv9' style='border-right: none;border-top: none; border-bottom: none;'>Sort By</td>
    <td class='tg-8fc1' style='border-left: none; border-top: none; border-bottom: none;'>:  ".$filter."</td>
  </tr>
  <tr>
...
<col style='width: 118px'>
  ...
  <tr>
    ...
    <th class="tg-a2cf">Size</th>
    <th class="tg-a2cf">Customer</th>
    <th class="tg-a2cf">Supplier</th>
    <th class="tg-a2cf">Batch No</th>
...
foreach($data as $row){  
    ...
    <td class="tg-h31u"><?php echo $row->Spec ; ?> <?php echo $row->Thick ; ?> X <?php echo $row->Width ; ?> X <?php echo $row->Length ; ?></td>
    <td class="tg-h31u"><?php echo $row->Code .' - '. $row->ProjectName ; ?></td>
    <td class="tg-h31u"><?php echo $row->partner_code; ?></td>
    <td class="tg-h31u"><?php echo $MatNum ;?></td>
