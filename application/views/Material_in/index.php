...
success	: function(data){
 ...
 function NotifFail(data){
      ...
      $("#PartNo").focus(function(e){
		var isi = $(e.target).val();
        CariProfilProduct();
	});
    
    $("#PartNo").click(function(e){
		var isi = $(e.target).val();
        CariProfilProduct();
	});
    ...
    function AmbilFormSearch(){
		...
		$.ajax({
			...
			success	: function(data){
                ...
                $("#Spec2Search").val(data.SpecOrder);
...
<input type="text" id="MaterialTypeID" name="MaterialTypeID" hidden="" readonly="readonly">
<div class="col-xs-8">
...
<input type="text" id="IDCust" name="IDCust" hidden="" readonly="readonly">
<div class="col-xs-8">
...
<input type="text" id="QtyPcs" name="QtyPcs"  hidden="" readonly="true" value="0" >
</div>
