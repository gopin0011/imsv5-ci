...
$('#reload').on('click', function() {
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/INFinishGood/TransactionList",
 data	: "kode="+kode,
 cache	: false,
...
function Detail_data2(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/INFinishGood/DataDetailMatIn2",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
...
$("#tab_tambah_detail").keyup(function(){
 Detail_data(); AmbilFormDetail();	 });
	...
	function Detail_data(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/INFinishGood/DataDetailMatIn",
			data	: "kode="+kode,
			cache	: false,
			success	: function(data){
...
$("#simpan").click(function(){
 ...
 var win = waitingDialog3.show('Processing ...', {dialogSize: 'sm', progressType: 'warning'}); 
  $.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/INFinishGood/SimpanMaterialIn",
 data	: string,
 cache	: false,
 success	: function(data){
 setTimeout(function(){
...
$("#Search").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/INFinishGood/ReadReport",
 data	: string,
 cache	: false,
 success	: function(data){
 setTimeout(function(){
...
$("#Download3").button('reset'); }, 1000);
 ...
 window.open('<?php echo site_url();?>/INFinishGood/ExportReport/'+string); 
...
$("#PrintList3").button('reset'); }, 1000);
 ...
 window.open('<?php echo site_url();?>/INFinishGood/PrintList2/'+string , 'myWindow', 
'status = 1, height = 650, width = 1100, resizable = 0, toolbar=no, location=no, status=no&#39, menubar=no, address bar=no' );
        ...
        function BackHome(){
        window.location.replace("<?php echo base_url();?>index.php/INFinishGood/");
        }
...
$("#HapusDetail").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/INFinishGood/Hapus_Transaksi",
...
$("#PrintList1").click(function(){
 var kode	= $("#DocNum").val();
 window.open('<?php echo site_url();?>/INFinishGood/PrintList/'+kode , 'myWindow', 
 'status = 1, height = 650, width = 1100, resizable = 0, toolbar=no, location=no, status=no&#39, menubar=no, address bar=no' );
 return false(); });
...
$("#PrintList2").click(function(){
 var kode	= $("#DocNum2").val();
 window.open('<?php echo site_url();?>/INFinishGood/PrintList/'+kode , 'myWindow', 
 'status = 1, height = 650, width = 1100, resizable = 0, toolbar=no, location=no, status=no&#39, menubar=no, address bar=no,scrollbars=1' );
 return false(); });
...
$("#Download2").click(function(){
 ...
 window.open('<?php echo site_url();?>/INFinishGood/ExportList/'+kode); 
 return false(); });
...
function MasterList(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/INFinishGood/MasterList",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
 setTimeout(function() {
...
function List_Material(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/INFinishGood/DataDetailMatIn3",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
 setTimeout(function() {
