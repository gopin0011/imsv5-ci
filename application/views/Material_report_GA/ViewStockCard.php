...
foreach($list as $row){
        ...
        $input = $this->app_model->CariJmlinputGA_ks1($row->ItemID,$tgl_awal,$tgl_akhir);
        $input2 = $this->app_model->GAStock($row->ItemID);
        $input3 = $this->app_model->CariJmlinputGA_ks1($row->ItemID,$tgl_awal,$tgl_akhir2);
