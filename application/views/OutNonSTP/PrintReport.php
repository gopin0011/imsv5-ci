...
$kanan = "
    ...
    <td class='tg-lntm' colspan='2' rowspan='3'>Production Non Press</td>
    <td class='tg-efv9' colspan='2' style='border-right: none; border-bottom: none;'>".$this->session->userdata('FullName')."</td>
...
<tr>
 ...
 <td class="tg-h31u"><?php echo $row->Status  ; ?></td>
</tr>
<?php
$no++;
	$g_total = $g_total;
