...
function tampil_data(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/OutNonSTP/TransactionList",
 data	: "kode="+kode,
 cache	: false,
...
function AmbilFormSearch(){
 ...
 $("#LotNoSearch").val(data.LotNo) ;
 $("#VanNoSearch").val(data.VanNo) ;
 waitingDialog3.hide();
 }  });  }; 
...
function AmbilFormEdit(){
 ...
 $("#DocNumDetail").val(data.DocNumDetailWeld);
...
function Detail_data2(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/OutNonSTP/DataDetailMatIn2",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
...
function AmbilForm(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/ref_json/InfoTambahFormProdWeld",
 data	: "kode="+kode,
 cache	: false,
 dataType : "json",
 success	: function(data){
...
function AmbilFormDetail(){
 ...
 $.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/ref_json/InfoTambahFormDetailProdWELD",
 data	: "kode="+kode,
 cache	: false,
 dataType : "json",
 success	: function(data){
...
function Detail_data(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/OutNonSTP/DataDetailMatIn",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
...
$("#Save").click(function(){
 ...
 if(Qty.length==0){ NotifFail('Total Produksi tidak boleh dikosongkan'); return false(); }
 if(Qty==0){ NotifFail('Total Produksi harus di isi');  return false(); }
 ...
 $.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/OutNonSTP/Save",
 data	: string,
 cache	: false,
 success	: function(data){
 setTimeout(function(){
...
$("#Search").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/OutNonSTP/ReadReport",
 data	: string,
 cache	: false,
 success	: function(data){
 setTimeout(function(){
...
window.open('<?php echo site_url();?>/OutNonSTP/ExportReport/'+string); 
 return false(); });
...
$("#PrintReport").button('reset'); }, 1000);
 ...
 window.open('<?php echo site_url();?>/OutNonSTP/PrintReport/'+string , 'myWindow', 
'status = 1, height = 650, width = 1100, resizable = 0, toolbar=no, location=no, status=no&#39, menubar=no, address bar=no' );
		return false(); });
    
function BackHome(){ window.location.replace("<?php echo base_url();?>index.php/OutNonSTP/"); }
...
$("#HapusDetail").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/OutNonSTP/Hapus_Transaksi",
...
$("#PrintList2").click(function(){
 var kode	= $("#DocNum2").val();
 window.open('<?php echo site_url();?>/OutNonSTP/PrintList/'+kode , 'myWindow', 
 'status = 1, height = 650, width = 1100, resizable = 0, toolbar=no, location=no, status=no&#39, menubar=no, address bar=no' );
 return false(); });
...
function MasterList(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/OutNonSTP/MasterList",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
 setTimeout(function() {
...
function List_Material(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/OutNonSTP/DataDetailMatIn3",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
 setTimeout(function() {
...
<div class="box">
<div class="box-body">
<?php  $cek = $this->Role_Model->TrcNonStampingView(); if(!empty($cek)){ ?>
...
<div class="col-xs-4">
<input type="number" id="IDLineDetail" name="IDLineDetail" class="form-control"  placeholder="Detail Line" >
</div></div>
...
<div class="form-group">
<label class="col-xs-4 control-label">Total Produksi</label>
<div class="col-xs-8">
<input type="text" id="Qty" name="Qty" value="0" class="form-control">
</div></div>

     <div class="form-group">
<label style="color: red;" class="col-xs-4 control-label">NG Scrap</label>
<div class="col-xs-8">
...
<div class="form-group">
<label class="col-xs-4 control-label">Checker by</label>
<div class="col-xs-8">
<input type="text" id="OP1" name="OP1"  class="form-control" placeholder="Check Man 1">
</div></div>

<div class="form-group">
<label class="col-xs-4 control-label">Checker by</label>
<div class="col-xs-8">
<input type="text" id="OP2" name="OP2"  class="form-control" placeholder="Check Man 2">
</div></div>

<div class="form-group">
<label class="col-xs-4 control-label">Lot / Van</label>
<div class="col-xs-4">
<input type="text" id="LotNo" name="LotNo"  class="form-control" placeholder="Lot No">
</div>
<div class="col-xs-4">
<input type="text" id="VanNo" name="VanNo"  class="form-control" placeholder="Van No">
</div></div>
...
<div class="form-group">
<label class="col-xs-4 control-label">OP</label>
<div class="col-xs-4">
...
<label class="col-xs-4 control-label">Lot / Van</label>
<div class="col-xs-4">
<input type="text" id="LotNoSearch" name="LotNoSearch"  class="form-control" readonly="">
</div>
<div class="col-xs-4">
<input type="text" id="VanNoSearch" name="VanNoSearch"  class="form-control" readonly="">
</div></div>
