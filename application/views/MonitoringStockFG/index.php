...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/MonitoringStockFG/ListProduct",
...
function NextID(){
 ...
 $.ajax({   
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/MonitoringStockFG/NextID",
 data	: "id="+id,
 cache	: false,
 dataType : "json",
 success	: function(data){
...
function NextIDCust(){
 ...
 $.ajax({   
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/MonitoringStockFG/NextIDCust",
 data	: "id="+id,
 cache	: false,
 dataType : "json",
 success	: function(data){
...
<a href="<?php echo base_url(); ?>" class="navbar-brand"><b>MONITORING</b>Stock<strong>FG</strong></a>
