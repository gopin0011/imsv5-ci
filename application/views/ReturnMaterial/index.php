...
function tampil_data(){
 ...
 $.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/ReturnMaterial/TransactionList",
 data	: "kode="+kode,
 cache	: false,
...
function List_Material(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/ReturnMaterial/List_Material",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
 setTimeout(function() {
...
function Detail_data2(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/ReturnMaterial/DataDetailMatIn2",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
...
$("#form-tab2").click(function(){
 ...
 setTimeout(function(){
   ...
   function AmbilForm(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/ref_json/InfoTambahFormRetMat",
			data	: "kode="+kode,
			cache	: false,
			dataType : "json",
			success	: function(data){
...
function AmbilFormDetail(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/ref_json/InfoTambahFormDetailRetMat",
 data	: "kode="+kode,
 cache	: false,
 dataType : "json",
 success	: function(data){
...
function Detail_data(){
 ...
 $.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/ReturnMaterial/DataDetailMatIn",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
 ...
 waitingDialog3.hide(); } }); }
   ...
   function NotifFail(data){
        ...
        function BackHome(){
        window.location.replace("<?php echo base_url();?>index.php/ReturnMaterial/");
        }
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/ReturnMaterial/Hapus_Detail",
...
$("#Search").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/ReturnMaterial/ReadReport",
 data	: string,
 cache	: false,
 success	: function(data){
 setTimeout(function(){
...
$("#Print4").click(function(){
 ...
 window.open('<?php echo site_url();?>/ReturnMaterial/PrintList2/'+string , 'myWindow', 
...
$("#Download").click(function(){
 ...
 window.open('<?php echo site_url();?>/ReturnMaterial/ExportReport/'+string);
 return false(); });
    
    $("#Print").click(function(){
		var kode	= $("#DocNum").val();
		window.open('<?php echo site_url();?>/ReturnMaterial/DetailPrint/'+kode , 'myWindow', 
'status = 1, height = 650, width = 1100, resizable = 0, toolbar=no, location=no, status=no&#39, menubar=no, address bar=no' );
		return false();
	});
...
'status = 1, height = 650, width = 1100, resizable = 0, toolbar=no, location=no, status=no&#39, menubar=no, address bar=no' );
    ...
    $("#Print3").click(function(){
		var kode	= $("#DocNum2").val();
		window.open('<?php echo site_url();?>/ReturnMaterial/PrintList/'+kode , 'myWindow', 
'status = 1, height = 650, width = 1100, resizable = 0, toolbar=no, location=no, status=no&#39, menubar=no, address bar=no' );
		return false();
	});
