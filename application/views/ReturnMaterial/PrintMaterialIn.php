...
<table width="1000" border="1" cellpadding="3" cellspacing="0">
  ...
  <tr class="style6" height="15">
    ...
    <td width="300" rowspan="3"><div align="center" class="style9"><img src="<?php echo site_url();?>/OUTMaterial/bikin_barcode/<?php echo $kodeoutput_bprm ;?>" style="width: 230px;"></div>    
  ...
  <tr class="style6">
    ...
    <td colspan="10" height="25" ><div align="center" class="style9"><?php echo $row->CreateBy; ?></div>   </tr>
  <tr>
  ...
  <td colspan="3"><div align="center" class="style6"></div>           
     <div align="center" class="style6"></div>      
      <div align="center" class="style6">
        <div align="left">Total : <strong><?php echo $total_keluar ; ?></strong></div>
    </div></td>
