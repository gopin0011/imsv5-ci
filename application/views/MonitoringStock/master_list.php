...
<?php
 ...
 $BalMat2 = ""  ;   } ;
 if($MaterialType == 1 ) {
 $UOM =  number_format($db->PcsPerKg ,4) ;            
 }else{
 $UOM = $db->PcsPerSheet  ;  } ;
 if($MaterialType == 1 ) {
 $StockPcs = $BalMat / $UOM  ;            
...
<tr>
 <td><?php echo $no ; ?></td>
 <?php echo $PartNo ; ?>
 <td align="left"><?php echo $db->Spec2  ; ?> (<?php echo $UOM ; ?><?php echo $BalMat2; ?>)</td>
 <td><span><?php echo number_format($BalMat) ; ?> / <?php echo number_format($StockPcs) ; ?></span></td>
...
function Data_Chart(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/MonitoringStock/ListProduct2",
 data	: "id="+id,
 cache	: false,
 dataType : "json",
