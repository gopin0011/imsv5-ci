...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/MasterPartner2/ListProduct",
data	: "&id="+id,
cache	: false,
...
$("#Save").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/MasterPartner2/Save",
 data	: string,
 cache	: false,
 success	: function(data){
 NotifSuccsess(data);
...
function CariProfilProduct(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/ref_json/InfoPartner2",
 data	: "kode="+kode,
 cache	: false,
 dataType : "json",
 success	: function(data){
...
$("#Hapus").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/MasterPartner2/Hapus_Product",
 data	: string,
 cache	: false,
 success	: function(data){
 NotifSuccsess(data);
