...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/MasterPartner/ListProduct",
data	: "&id="+id,
cache	: false,
...
$("#Save").click(function(){
 ...
 if(partner_code.length==0){ NotifFail('Kode Supplier Harus Di isi');   return false(); } 
 if(partner_name.length==0){ NotifFail('Nama Supplier Harus Di isi');  return false(); } 
 $.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/MasterPartner/Save",
 data	: string,
 cache	: false,
 success	: function(data){
 NotifSuccsess(data);
...
$("#Hapus").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/MasterPartner/Hapus_Product",
 data	: string,
 cache	: false,
 success	: function(data){
 NotifSuccsess(data);
...
<?php  $cek = $this->Role_Model->MPartnerUp() ; if(!empty($cek)){ ?>
...
<div class="box">
<div class="box-body">
<?php  $cek = $this->Role_Model->MPartnerView() ; if(!empty($cek)){ ?>
...
<div class="col-xs-8">
<input type="text" id="partner_code" name="partner_code"  class="form-control">
</div></div>
 <div class="form-group">
...
<input type="text" id="id" name="id"  class="form-control" readonly="true">
 ...
 <?php  $cek = $this->Role_Model->MPartnerDel() ; if(!empty($cek)){ ?>
