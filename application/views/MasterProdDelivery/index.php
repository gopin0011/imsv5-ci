...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/MasterProdDelivery/ConectingBomList",
data	: "&id="+id,
cache	: false,
success	: function(data){
...
<?php  $cek = $this->Role_Model->MProdDeliveryUp(); if(!empty($cek)){ ?>
...
<div class="box">
<div class="box-body">
<?php  $cek = $this->Role_Model->MProdDeliveryView(); if(!empty($cek)){ ?>
...
$.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/MasterProdDelivery/SelectBOM",
...
$.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/MasterProdDelivery/DeleteConecting",
 data	: "&SysID="+SysID,
 cache	: false,
 success	: function(data){
