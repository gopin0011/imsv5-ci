...
$kanan = "
  <tr>
    ...
    <td class='tg-lntm' colspan='3' rowspan='3'>Product - IN</td>
  </tr>
  <tr>
...
$QtyMat =  $row->QtyMat ;  
 ...
 $UOM= $row->CodeUnit;
    ...
    <td class="tg-h31u1"><?php echo $row->CustName; ?></td>
    <td class="tg-h31u12"><?php echo number_format($QtyMat); ?> &nbsp;</td>
    <td class="tg-h31u"><?php echo $row->Remark; ?></td>
  </tr>
<?php
$no++;
	$g_total = $g_total;
