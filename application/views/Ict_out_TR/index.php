...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Ict_out_TR/transaction_list",
data	: "kode="+kode,
cache	: false,
...
function AmbilFormEdit(){
 ...
 $("#DocNumDetail").val(data.DocNumDetailOutICT);
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Ict_out_TR/transaction_detail_2",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Ict_out_TR/transaction_detail",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$("#QtyMat").keypress(function(data){
 ...
 return false; } });
        ...
        var stock = 0;
        if((parseFloat($('#Total').val()) - parseFloat($('#QtyMat').val())) < 0)
        {
            stock = parseFloat($('#StockWIP2').val()) + (parseFloat($('#Total').val()) - parseFloat($('#QtyMat').val()));
        } 
        else
        {
            if(parseFloat($('#Total').val()) > parseFloat($('#QtyMat').val()))
                stock = parseFloat($('#StockWIP2').val()) + (parseFloat($('#Total').val()) - parseFloat($('#QtyMat').val()));
            else
                stock = parseFloat($('#StockWIP2').val()) - (parseFloat($('#Total').val()) - parseFloat($('#QtyMat').val()));
        }
        
        stock = (parseFloat($('#Total').val())>0) ? stock : parseFloat($('#StockWIP2').val()) - parseFloat($('#QtyMat').val());
        $('#Balance').val(stock);
        }
...
$("#form-tab").click(function(){
   ...
   function AmbilForm(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Ict_out_TR/InfoTambahFormTRMatIn",
			data	: "kode="+kode,
			cache	: false,
			dataType : "json",
			success	: function(data){
   ...
   function AmbilFormDetail(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/Ict_out_TR/InfoTambahFormDetailTRMatIN",
			data	: "kode="+kode,
			cache	: false,
			dataType : "json",
			success	: function(data){
...
$("#Search").click(function(){
 ...
 $.ajax({
 type	 : 'POST',
 url	 : "<?php echo site_url(); ?>/Ict_out_TR/ReadReport",
 data	 : string,
 cache	: false,
 success	: function(data){
 setTimeout(function(){
...
$("#ExportList3").click(function(){
 ...
 window.open('<?php echo site_url();?>/Ict_out_TR/ExportReport/'+string); return false(); });
 ...
 $("#HapusDetail").click(function(){
	...
	$.ajax({
	type	: 'POST',
	url		: "<?php echo site_url(); ?>/Ict_out_TR/Hapus_Detail",
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Ict_out_TR/MasterList",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Ict_out_TR/MasterListPic",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/Ict_out_TR/MasterList2",
data	: "kode="+kode,
cache	: false,
success	: function(data){
...
<div class="box">
<div class="box-body">
<?php  $cek = $this->Role_Model->TrcICTView(); if(!empty($cek)){ ?>
