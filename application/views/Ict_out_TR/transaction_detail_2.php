...
<a onfocus="PilihHapus('<?php echo $DocNumDetail ; ?>', '<?php echo $DocNumDetail ; ?>', '<?php echo $row->CanEdit ; ?>')" href="#tab_content2" data-toggle="tab" aria-expanded="false" >
