...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/MasterCust/ListProduct",
data	: "&id="+id,
cache	: false,
...
$("#Save").click(function(){
 ...
 if(Code.length==0){ NotifFail('Kode Customer Harus Di isi');   return false(); } 
 if(CustName.length==0){ NotifFail('Nama Customer Harus Di isi');  return false(); } 
 $.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/MasterCust/Save",
 data	: string,
 cache	: false,
 success	: function(data){
 NotifSuccsess(data);
...
function CariProfilProduct(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/ref_json/InfoCust",
 data	: "kode="+kode,
 cache	: false,
 dataType : "json",
 success	: function(data){
...
$("#Hapus").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/MasterCust/Hapus_Product",
 data	: string,
 cache	: false,
 success	: function(data){
 NotifSuccsess(data);
...
<div class="box">
<div class="box-body">
<?php  $cek = $this->Role_Model->MCustView(); if(!empty($cek)){ ?>
...
<input type="text" id="RegID" name="RegID"  class="form-control" readonly="true">
 ...
 <?php  $cek = $this->Role_Model->MCustDel(); if(!empty($cek)){ ?>
