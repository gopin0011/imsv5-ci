...
{
    //window.open('<?php echo site_url();?>/SuratJalanWH/PrintList2/'+RegID,'',' scrollbars=yes,menubar=no,width=1100,height=600, resizable=yes,toolbar=no,location=no,status=no');
    $.ajax({
        type	: 'POST',
        url		: "<?php echo site_url(); ?>/SuratJalanWH/PrintList2/",
        data	: "RegID="+RegID,
        cache	: false,
