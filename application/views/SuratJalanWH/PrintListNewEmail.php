...
<?php
    ...
    function myheader($kanan,$DocNum,$DocDate,$PONum,$DNRef,$PartnerName,$DlvAddress,$username,$CarNum,$ShipTime,$ShipCycle,$shipper,$Remark,$page,$ofPage)
    {
        ...
        echo '<span><b>PT. Summit Adyawinsa Indonesia</b><br>';
        ...
        echo '<td width="50%"><div class="images"><img src="'.base_url().'/images/adw.png" width="250" height="59"><br><br><br><p>page: '.$page.' of '.$ofPage.'</p></div></td></tr></table>';
...
<script>
    $(document).ready(function(){
        if($('#IsConfirm').val()=='1')
        {
            $('#confirm').attr({'class':'btn btn-warning','onclick':'proses_confirm(this,2);','data-id':$('#RegIDConfirm').val()});
        ...
        {
            $('#confirm').attr({'class':'btn btn-success','onclick':'proses_confirm(this,1);','data-id':$('#RegIDConfirm').val()});
