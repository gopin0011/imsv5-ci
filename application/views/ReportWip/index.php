...
$("#StockWIP2").focus(function(){
 var  StockWIP2 = $("#StockWIP2").val();
 if(StockWIP2 == 0){ $("#StockWIP2").val(""); return false(); }  });
$("#StockWIP2").focusout(function(){ var  StockWIP2 = $("#StockWIP2").val();
 if(StockWIP2.length==0){ $("#StockWIP2").val("0"); return false(); } });
$("#PcsPerday").focus(function(){
 var  PcsPerday = $("#PcsPerday").val();
 if(PcsPerday == 0){ $("#PcsPerday").val(""); return false(); }  });
$("#PcsPerday").focusout(function(){
 var  PcsPerday = $("#PcsPerday").val();
...
function MasterList(){
 ...
 $.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/ReportWip/MasterList",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
 setTimeout(function() {
...
function MasterList2(){
 ...
 $.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/ReportWip/MasterList2",
 data	: "kode="+kode,
 cache	: false,
 success	: function(data){
 setTimeout(function() {
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/ReportWip/ReadReport",
data	: string,
cache	: false,
success	: function(data){
setTimeout(function(){
...
$("#Export").click(function(){
 ...
 var win = waitingDialog3.show('Processing ...', {dialogSize: 'sm', progressType: 'warning'});
    setTimeout(function(){
	waitingDialog3.hide();
    window.open('<?php echo site_url();?>/ReportWip/ExportReport/'+string);
	},1000)       
	return false(); });    
...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/ReportWip/ReadStockCard",
data	: string,
cache	: false,
success	: function(data){
setTimeout(function(){
...
$("#Save").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/ReportWip/Save",
 data	: string,
 cache	: false,
 success	: function(data){
...
<div class="form-group">
<label style="text-align: left;" class="col-lg-4 control-label">1.&nbsp; Stock < 1</label>
<label style="text-align: left;" class="col-lg-4 control-label">: <strong>Danger</strong></label>
<label style="text-align: left;" class="col-lg-4 control-label">
<img style="height: 20px; width: 20px;" src="<?php echo base_url(); ?>images/INDOKATOR/Danger.gif"/>
</label>
</div>

<div class="form-group">
<label style="text-align: left;" class="col-lg-4 control-label">2.&nbsp; 1 - 3,99 Day </label>
<label style="text-align: left;" class="col-lg-4 control-label">: <strong>Safe</strong></label>
<label style="text-align: left;" class="col-lg-4 control-label">
...
<div class="form-group">
<label style="text-align: left;" class="col-lg-4 control-label">3.&nbsp; 4 - 10 Day  </label>
<label style="text-align: left;" class="col-lg-4 control-label">: <strong>Warning</strong></label>
<label style="text-align: left;" class="col-lg-4 control-label">
...
<div class="form-group">
<label style="text-align: left;" class="col-lg-4 control-label">4.&nbsp; > 10 Day </label>
<label style="text-align: left;" class="col-lg-4 control-label">: <strong>Over</strong></label>
<label style="text-align: left;" class="col-lg-4 control-label">
...
<?php 
foreach($l_MProject->result() as $t){ if($IDProject==$t->ProjectName){ ?>
...
<div class="col-lg-8">
<select name="IsWIP" id="IsWIP" class="form-control">
...
<div class="col-md-6">
 <div class="form-group">
<label class="col-lg-4 control-label">Need Per Day</label>
<div class="col-lg-8">
<input type="text" id="PcsPerday" name="PcsPerday"  class="form-control" placeholder="Stock WIP">
</div> 
</div>  
 <div class="form-group">
<label class="col-lg-4 control-label">Stock</label>
<div class="col-lg-8">
<input type="text" id="StockWIP2" name="StockWIP2"  class="form-control" placeholder="Stock WIP">
</div> 
</div>
</div>
</div></div></div></div></form>
