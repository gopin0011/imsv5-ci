...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/MasterProdGA/ListProduct",
data	: "&id="+id,
cache	: false,
...
$("#Save").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/MasterProdGA/Save",
 data	: string,
 cache	: false,
 success	: function(data){
 NotifSuccsess(data);
...
$("#Hapus").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/MasterProdGA/Hapus_Product",
 data	: string,
 cache	: false,
 success	: function(data){
 NotifSuccsess(data);
...
<?php  $cek = $this->Role_Model->MProdGAUp(); if(!empty($cek)){ ?>
...
<div class="box">
<div class="box-body">
<?php  $cek = $this->Role_Model->MProdGAView(); if(!empty($cek)){ ?>
