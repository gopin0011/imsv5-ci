...
<tr>
    ...
    <td class='tg-lntm' colspan='5' rowspan='3'>Material Out</td>
  </tr>
  <tr>
...
foreach($data as $row){  
 ...
 ?>
    ...
    <td class="tg-h31u" colspan="2"><?php echo $row->Spec ; ?> <?php echo $row->Thick ; ?> X <?php echo $row->Width ; ?> X <?php echo $row->Length ; ?></td>
    <td class="tg-h31u"><?php echo $row->Code .' '. $row->ProjectName; ?></td>
    <td class="tg-h31u12"><?php echo $row->Qty_5 ;?> <?php echo $UOM ; ?></td>
