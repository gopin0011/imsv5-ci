...
<script>
    ...
    $(document).ready(function()
    {
        ...
        function tampil_data()
        {
            ...
            $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/SuratJalanMkt/TransactionList",
                data	: "kode="+kode,
                cache	: false,
        ...
        function Detail_data()
        {
            ...
            $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/SuratJalanMkt/DetailData",
                data	: "kode="+kode,
                cache	: false,
                success	: function(data)
                {
        ...
        function AmbilForm()
        {
            ...
            $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/SuratJalanMkt/InfoTambahFormInFG",
                data	: "kode="+kode,
                cache	: false,
                dataType : "json",
                success	: function(data)
        ...
        $('#simpan').click(function(){
           ...
           else 
           {
            ...
            $.ajax({
                type	: 'POST',
                url	: "<?php echo site_url(); ?>/SuratJalanMkt/simpan",
                data	: string,
                cache	: false,
                success	: function(data){
                setTimeout(function(){
        ...
        {
            var kode	= $("#DocNum").val();
            window.open('<?php echo site_url();?>/SuratJalanMkt/PrintList/'+kode , 'myWindow', 
        ...
        function Detail_data2()
        {
            ...
            $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/SuratJalanMkt/GetData",
                data	: "kode="+kode,
                cache	: false,
                success	: function(data){
            ...
            $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/SuratJalanMkt/DataDetailMatIn2",
                data	: "kode="+kode,
                cache	: false,
                success	: function(data){
        ...
        $('#PrintList2').click(function(){
           window.open('<?php echo site_url();?>/SuratJalanMkt/PrintList/'+$(this).attr('data-ref'),'',' scrollbars=yes,menubar=no,width=1100,height=600, resizable=yes,toolbar=no,location=no,status=no'); 
        });
        ...
        function MasterList2()
        {
            ...
            $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/SuratJalanMkt/MasterList2",
                data	: "kode="+kode,
                cache	: false,
                success	: function(data)
                {
        ...
        $("#Search").click(function()
        {
            ...
            $.ajax({
                type	 : 'POST',
                url	 : "<?php echo site_url(); ?>/SuratJalanMkt/ReadReport",
                data	 : string,
                cache	: false,
                success	: function(data){
                setTimeout(function()
        ...
        $('#PrintList3').click(function(){
            ...
            window.open('<?php echo site_url();?>/SuratJalanMkt/PrintListReport/'+string , 'myWindow', 
            'status = 1, height = 650, width = 1100, resizable = 0, toolbar=no, location=no, status=no&#39, menubar=no, address bar=no' );
            return false();
        });
...
<div class="box-body"><div class="box box-success">
...
<div id="header_data2a"></div>
</div>
</div></div></div>
</div></div></div>

<script>
        function notif_confirm()
        {
            $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/SuratJalanMkt/GetNotif",
                data	: "kode=",
                cache	: false,
                success	: function(data)
                {
                    var d = JSON.parse(data);
                    $('#notif_mkt_confirm').html(d.Waiting);
                } 
            });
    ...
    function proses_confirm(obj,status)
    {
        ...
        $.ajax({
            type	: 'POST',
            url		: "<?php echo site_url(); ?>/SuratJalanMkt/update_confirm/",
    ...
    {
        var id = $("#DocDate").val();
        var RegID = $('#confirm').data('id');        
         //$('#Send').button('loading');
        $.ajax({
            type	: 'POST',
            url		: "<?php echo site_url(); ?>/SuratJalanMkt/SendMailSuratJalan2",
...
<i class="fa  fa-plus"></i> Transaction</a>-->
...
<script>
    ...
    */
    function cari_docnum()
    {
        ...
        $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/SuratJalanMkt/GetDocNumReport",
                data	: "DocNum="+val,
                cache	: false,
                success	: function(data)
                {
