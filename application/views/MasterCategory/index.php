...
$.ajax({
type	: 'POST',
url		: "<?php echo site_url(); ?>/MasterCategory/ListProduct",
data	: "&id="+id,
cache	: false,
...
$("#Save").click(function(){
 ...
 if(code.length==0){ NotifFail('Kode Kategori Harus Di isi');   return false(); } 
 if(category_name.length==0){ NotifFail('Nama Kategori Harus Di isi');  return false(); } 
 if(GroupBy.length==0){ NotifFail('Group Harus Di isi');  return false(); } 
 $.ajax({
 type	: 'POST',
 url	: "<?php echo site_url(); ?>/MasterCategory/Save",
 data	: string,
 cache	: false,
 success	: function(data){
 NotifSuccsess(data);
...
function CariProfilProduct(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/ref_json/InfoCategory",
 data	: "kode="+kode,
 cache	: false,
 dataType : "json",
 success	: function(data){
...
$("#Hapus").click(function(){
 ...
 $.ajax({
 type	: 'POST',
 url		: "<?php echo site_url(); ?>/MasterCategory/Hapus_Product",
 data	: string,
 cache	: false,
 success	: function(data){
 NotifSuccsess(data);
...
<?php  $cek = $this->Role_Model->MCategoryUp(); if(!empty($cek)){ ?>
...
<div class="box">
<div class="box-body">
<?php  $cek = $this->Role_Model->MCategoryView(); if(!empty($cek)){ ?>
...
<label class="col-lg-4 control-label">Group</label>
     ...
     <option value="TR" >Tool Room</option>
...
<input type="text" id="id" name="id"  class="form-control" readonly="true">
 ...
 <?php  $cek = $this->Role_Model->MCategoryDel(); if(!empty($cek)){ ?>
